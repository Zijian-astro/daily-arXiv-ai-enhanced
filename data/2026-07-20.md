...
TL;DR: ML-assisted reconstruction of the Milky Way rotation curve using 73 data points (0.1-95.56 kpc); Ridge regression performs best (R²=0.9824, RMSE=3.75 km/s); embedded into relativistic spacetime geometry, verifying energy conditions, stability, and attractive gravity.


<details>
  <summary>Details</summary>
Motivation: To provide a statistically validated, data-driven alternative to conventional dark matter halo models and to directly connect kinematical observables with relativistic spacetime geometry.

Method: Compared Ridge regression, LASSO regression, and feed-forward neural networks on a physically motivated functional basis using 73 observational rotation curve data points; embedded the best-fit velocity profile into a static, spherically symmetric spacetime via Einstein's equations.

Result: Ridge regression achieved R²=0.9824±0.0064 and RMSE=3.75 km/s; all energy conditions satisfied, sound speed subluminal, circular orbits stable, gravitational energy negative.

Conclusion: The framework offers a data-driven, analytically interpretable reconstruction of the rotation curve that connects directly to relativistic spacetime geometry, bypassing conventional dark matter halo modeling assumptions.
...
TL;DR: A neural-network-corrected Projected Mass Estimator improves Milky Way and galaxy group mass measurements, reducing bias from ~30-46% overestimation to ~2% with 0.13 dex RMSE, yielding M_MW = 1.144^+0.399_-0.296 × 10^12 M_⊙.


<details>
  <summary>Details</summary>
Motivation: Classical dynamical estimators (e.g., PME) overestimate total masses of the Milky Way and nearby galaxy groups due to violations of satellite orbital geometry assumptions and limited tracer numbers.

Method: A residual neural network trained on IllustrisTNG simulations corrects the PME bias, with separate networks for satellite sample sizes from 5 to 50 to account for statistical noise.

Result: Classical PME overestimates masses by factors of 1.30^+0.72_-0.62 (2D) and 1.46^+0.97_-0.72 (3D) with ~0.3 dex RMSE; neural-network correction reduces this to 1.02^+0.30_-0.26 with 0.13 dex RMSE. Milky Way mass = 1.144^+0.399_-0.296 × 10^12 M_⊙.

Conclusion: The modified PME provides tighter constraints on virial masses and dark matter rates in galaxy groups and clusters, with the brightest 5-10 satellites favoring a lower mass range of (0.8-0.95) × 10^12 M_⊙ for the Milky Way.
...
TL;DR: Using ultra-deep imaging reaching μ = 30 mag arcsec⁻², the authors measure IC 1101's edge radius at 260 kpc (semi-major axis), enclosing 3.4 × 10¹² M☉ in stars, making it the largest known galaxy with a confirmed diameter of ~520 kpc, though its outskirts show ongoing mass assembly.


<details>
  <summary>Details</summary>
Motivation: To constrain the upper limit of galaxy sizes at the present epoch by studying IC 1101, one of the most extended and massive galaxies known, and to determine whether it has a detectable edge.

Method: Ultra-deep g- and r-band INT/WFC imaging reaching μ = 30 mag arcsec⁻² (3σ, 10×10 arcsec²); scattered light from stars and galaxy removed via extended PSF characterization and hybrid wavelet-based deconvolution; surface brightness, colour, and stellar mass density profiles at multiple position angles.

Result: IC 1101's main body extends to R_edge = 260 kpc along the semi-major axis (z=0.077), enclosing 3.4×10¹² M☉; this edge radius is among the largest measured for any galaxy; numerous asymmetrical, very low surface brightness features are spatially consistent with X-ray disturbances in the Abell 2029 intracluster medium.

Conclusion: IC 1101 is the largest known galaxy with a confirmed diameter of ~520 kpc, placing it at the extreme upper end of the mass-size relation; its outskirts show clear signatures of ongoing mass assembly, indicating its spatial extent is still growing.
...
TL;DR: The Azahar simulation suite shows that incorporating radiative transfer and cosmic rays alongside standard physics reproduces JWST observations of early galaxies, while simple thermal supernova feedback models fail due to lacking realistic multi-timescale feedback channels.


<details>
  <summary>Details</summary>
Motivation: JWST observations have revealed significant deficiencies in state-of-the-art galaxy formation simulations, motivating the need for novel, physically grounded models to interpret early galaxy populations.

Method: The Azahar suite comprises ten high-resolution (~20 pc), large-volume zoom-in cosmological simulations that progressively incorporate radiative transfer (RT), cosmic rays (CRs), and magnetohydrodynamics (MHD) alongside standard baryonic physics. The Non-Thermal model includes RT and CRs on the fly.

Result: The Non-Thermal model reproduces observed UV luminosity functions from z~14 to z~3, stellar mass function evolution, the galaxy main sequence, and observed gas metallicities. It achieves this via burstier star formation with enhanced variability on both long (>50 Myr) and short (<10 Myr) timescales, and a transition from high to low outflow mass-loading factors as CR pressure builds up. Simple thermal SN feedback models either overproduce stellar mass or drive overly explosive outflows.

Conclusion: Non-thermal galaxy formation physics (RT, CRs, MHD) is crucial for providing a robust theoretical framework to interpret high-redshift galaxy populations uncovered by JWST.
...
TL;DR: The paper presents P3D, a 3D reconstruction of thermal phases in the local interstellar medium (within 1 kpc of the Sun), revealing cold clouds surrounded by thermally unstable envelopes embedded in warm gas. About 41% of neutral mass near the Galactic midplane is thermally unstable, cycling on ~2.9-6 Myr timescales, while the cold phase remains transonic, challenging single-phase supersonic star-formation models.


<details>
  <summary>Details</summary>
Motivation: To move beyond the statistical picture of neutral-gas phases from 21-cm observations and map the three-dimensional architecture of thermal phases in the local interstellar medium, which had not been previously achieved.

Method: P3D combines high-resolution 3D maps of dust extinction and interstellar far-ultraviolet radiation with a neutral-ISM thermochemical model, covering a 1 kpc-diameter region centered on the Sun sampled on a 2 pc Cartesian grid.

Result: Within |z| ≤ 150 pc of the Galactic midplane, ~41% of dust-traced neutral mass is thermally unstable, implying phase cycling on a timescale of ~2.9-6 Myr. The cold phase has a narrow density distribution with internal Mach numbers at most transonic (Ms ≲ 1.5).

Conclusion: The findings favor a dynamically cycling multiphase ISM and motivate reassessing star-formation models that assume a single-phase, strongly supersonic cold-gas density field.
...
TL;DR: JWST discovered unexpectedly bright early galaxies; the Azahar simulation suite's "Full-Physics" model (including comprehensive non-thermal physics) produces compact, self-regulated galaxies matching observations from z=12 to z=3, while standard hydrodynamics or calibrated supernova feedback fail to reproduce observed sizes.


<details>
  <summary>Details</summary>
Motivation: JWST observed bright, rapidly growing galaxies in the early universe that were not predicted by most existing galaxy formation models, motivating a re-examination of simulation physics.

Method: Using synthetic JWST observations of the Azahar simulation suite, the study compares three models: "Full-Physics" (comprehensive non-thermal physics), standard hydrodynamics, and calibrated supernova feedback, analyzing surface brightness distributions, sizes, and star formation histories.

Result: Full-Physics model produces compact, self-regulated galaxies matching JWST observations from z=12 to z=3 with broad surface brightness distributions dominated by compact sizes and bursty star formation. Standard hydrodynamics yields overly small/concentrated systems; calibrated supernova feedback produces unphysically large galaxies (~2x observed size). At M* < 10^8 M☉, Full-Physics predicts sizes below JWST resolution, consistent with higher-mass extrapolations.

Conclusion: The compact starburst scenario naturally explains bright z>10 galaxies in flux-limited surveys. Future higher-resolution observations could resolve the predicted low-mass population and clarify the physics of first galaxy formation.
...
TL;DR: This paper analyzes 20 young stellar objects in Ophiuchus A using VLA, JWST, and ALMA data, finding circumstellar dust disks are tens to hundreds of times more massive than millimeter-only estimates and detecting protostellar jet emission, offering a potential solution to the 'missing disk mass' problem.


<details>
  <summary>Details</summary>
Motivation: To address the 'missing disk mass' problem and provide a homogeneous characterization of dust and ionized gas properties in young stellar objects by combining high-resolution multi-wavelength observations.

Method: Combined high-resolution (7-25 au) VLA and JWST observations with archival ALMA data across infrared, millimetre, and radio bands. Implemented physically motivated models to analyze dust and ionised gas properties and their contributions to the millimetre-centimetre radio SED.

Result: Circumstellar dust disks are tens to hundreds of times more massive than millimetre-only estimates; millimetre-sized grains present even at Class 0 stage; protostellar jet emission detected on scales of 10s-1000s au.

Conclusion: The results offer a potential solution to the 'missing disk mass' problem, but resolution and sensitivity at frequencies <40 GHz remain limiting. Future facilities (SKA, ngVLA) are needed to fully spatially resolve this emission.
...
TL;DR: This paper analyzes 405 JWST/NIRSpec spectra of star-forming galaxies at z=4.5–10.1 to study chemical enrichment in low-mass galaxies, deriving new metallicity calibrations down to M⋆~10^6.6 M⊙, tracing the mass–metallicity relation to low masses, and finding evidence for nitrogen-rich populations possibly linked to Wolf–Rayet stars and globular-cluster-like enrichment.


<details>
  <summary>Details</summary>
Motivation: To understand chemical enrichment in intrinsically faint, low-mass galaxies at high redshift (z=4.5–10.1), probing the mass–metallicity relation and abundance patterns in the early Universe, particularly for galaxies too faint to be studied without JWST and gravitational lensing.

Method: Analysis of 405 deep JWST/NIRSpec spectra from DREAMS and lensing-cluster surveys; derivation of gas-phase metallicity, nitrogen, and carbon abundances from rest-frame UV and optical lines; development of new strong-line metallicity calibrations using direct-method measurements from stellar-mass-binned stacks; comparison with BPASS predictions and hydrodynamical simulations.

Result: Traced the z~6 mass–metallicity relation down to M⋆~10^6.6 M⊙ with metallicity 12+log(O/H)~7.2; found N/O from NIV] exceeds that from [NII] by ~1.4 dex in M⋆~10^7.7 M⊙ stack; detected HeII λ4686/Hβ~0.03 above BPASS predictions; UV–optical abundance differences suggest N-rich, subsolar C/O populations resembling globular-cluster stars.

Conclusion: WR stars may contribute both prompt CNO-cycle enrichment and hard ionizing radiation in low-mass high-z galaxies, potentially supplying enough nitrogen to account for excess on globular-cluster scales.
...
TL;DR: This paper identifies and characterizes 25 repeating changing-look active galactic nuclei (RCL AGNs), 22 of which are newly discovered. These objects show recurrent appearances/disappearances of broad emission lines. The study finds transition intervals of 3–4 years, line-dependent Eddington-ratio thresholds (Hβ-only transitions occur at higher Eddington ratios than Hα+Hβ transitions), and consistency between photometric variability and on/off states. Results support a model where accretion-flow changes drive reversible ionizing emission variations, and BLR "breathing" across visibility thresholds produces observed RCL transitions.


<details>
  <summary>Details</summary>
Motivation: Repeating CL AGNs (RCL AGNs) are particularly valuable because they cross the same physical boundaries multiple times, offering clearer insights into the mechanisms behind CL transitions than single-occurrence events.

Method: Long-term multi-band light curves were used to search for RCL AGN candidates from known CL-AGN samples. 34 candidates were selected, and 25 were confirmed via spectroscopic follow-up (22 new). Eddington ratios, transition timescales, and line behaviors (Hβ-only vs. Hα+Hβ) were analyzed.

Result: 25 RCL AGNs confirmed; rest-frame second transitions mostly 3–4 yr, some optical variations on months. On/off states correspond to higher/lower Eddington ratios; seven with good light-curve coverage show multi-year optical excursions matching Eddington-ratio changes. Hβ-only transitions occur at higher Eddington ratios than those involving both Hα and Hβ.

Conclusion: Reversible accretion-flow changes drive variations in central ionizing emissions, and BLR breathing across line-dependent visibility thresholds produces the observed RCL transitions. The line-dependent thresholds (Hβ vs. Hα+Hβ) support a picture of distinct BLR region responses to changing ionizing flux.
...
TL;DR: This paper presents the first blind search for OH 18-cm absorption using FAST, conducted alongside HI 21-cm absorption surveys. From 394.4 hours of data covering 1622.1 deg², they identified 41 HI absorption systems (34 from previous work, 7 new). Searching for OH in 19 systems with appropriate redshift, they only re-detected the known OH absorber towards PKS 1413+135. No significant correlation between N_OH and N_HI or redshift evolution was found. Spectral stacking placed the strongest upper limits on OH/HI ratios (down to <0.90×10⁻⁸), establishing a benchmark for future blind OH surveys.


<details>
  <summary>Details</summary>
Motivation: To perform the first blind survey for OH 18-cm absorption using FAST, extending previous blind HI 21-cm absorption searches to probe molecular gas content in HI-selected systems and establish constraints on OH abundance and its relation to HI.

Method: Analysis of 2024–2025 CRAFTS and FASHI data (394.4 hr, 1622.1 deg²) plus FATHOMER observations to identify HI 21-cm absorbers. A targeted search for OH 18-cm absorption was conducted in 19 systems where OH frequencies fall within FAST's band. Survival analysis accounting for upper limits was used to examine N_OH–N_HI correlation and redshift evolution. Spectral stacking was performed to derive OH column density upper limits.

Result: 41 HI absorption systems total (34 previously known + 7 new). Only one OH detection (PKS 1413+135, previously known). No significant N_OH–N_HI correlation or redshift evolution. Stacking yielded 3σ OH column density upper limits of 4.93, 1.64, and 1.72 T_ex/c_f,OH ×10¹² cm⁻² K⁻¹ for associated, intervening, and combined samples, corresponding to [OH]/[HI] ratios <1.66×10⁻⁸, <1.42×10⁻⁸, and <0.90×10⁻⁸.

Conclusion: Results place the strongest constraints to date on OH content in radio-selected HI absorbers, establish a blind-survey benchmark for future molecular gas studies, and demonstrate that HI 21-cm absorbers serve as an effective parent sample for systematic OH absorption searches.
...
TL;DR: This paper uses synthetic galaxy images from IllustrisTNG simulations to predict how CASTOR and NGRST surveys will observe star formation quenching. They generate mock observations accounting for dust and noise, recover stellar mass and SFR via photometric fitting, and classify quenching galaxies (inside-out vs. outside-in) using morphological metrics and machine learning. They forecast thousands of quenching galaxies detectable out to intermediate and higher redshifts.


<details>
  <summary>Details</summary>
Motivation: To predict and enable the classification of star formation quenching mechanisms using upcoming CASTOR and NGRST surveys, by testing whether synthetic observations can recover spatially resolved quenching signatures.

Method: Simulations from IllustrisTNG processed with GALAXEV stellar population synthesis; dust and noise added to create mock CASTOR/NGRST observations; photometric fitting with FAST++ using flexible star formation histories in binned circular annuli; morphological metrics measured; machine learning used to classify quenching mechanisms (inside-out vs. outside-in).

Result: Quenching galaxies can be distinguished from mass-matched normal star-forming galaxies. Inside-out and outside-in quenching signatures can be separated with reliable accuracy via machine learning. Surveys are predicted to classify thousands of quenching galaxies out to intermediate redshifts, with more at higher redshifts.

Conclusion: Upcoming CASTOR and NGRST surveys will enable robust, spatially resolved classification of galaxy quenching mechanisms and their evolutionary stages, providing large statistical samples for studying galaxy quenching across cosmic time.
...
TL;DR: This paper compares different formalisms for grain surface chemistry mechanisms (non-diffusive chemistry, radiolysis, and chemical desorption) implemented in the astrochemical model Nautilus, finding that radiolysis has negligible impact, non-diffusive chemistry effects depend on the formalism, chemical desorption can alter gas-phase abundances by up to 10x, and the standard model without non-diffusive chemistry with Fredon et al. (2021) chemical desorption best matches observed gas-phase abundances.


<details>
  <summary>Details</summary>
Motivation: To systematically compare recently added mechanisms for grain surface chemistry (non-diffusive chemistry, radiolysis, and chemical desorption) and evaluate their impact on astrochemical model predictions of gas-phase and ice abundances.

Method: Different formalisms for non-diffusive chemistry, radiolysis, and chemical desorption were implemented in the Nautilus astrochemical model. Predicted gas-phase and ice abundances were compared against each other and against observed compositions.

Result: Radiolysis has no significant influence. Non-diffusive chemistry impacts gas and ice species but depends on the formalism; Shingledecker & Herbst (2018) formalism alters main reservoirs in ices. Chemical desorption can cause up to 10-fold differences in gas-phase abundances. The standard model (no non-diffusive chemistry, Fredon et al. 2021 chemical desorption) best matches observed gas-phase abundances.

Conclusion: Formalisms for grain surface processes significantly affect even gas-phase predictions. More experiments are needed to constrain process efficiencies, particularly the uncertain energy fraction parameter in chemical desorption formalisms.
...
TL;DR: This paper reviews the principles of galactic chemical evolution, using the "time-delay model" to interpret [X/Fe] vs. [Fe/H] relations and reconstruct star formation histories of galaxies (spirals, ellipticals, and especially the Milky Way), tracing the evolution from early models to modern ones and outlining future improvements.


<details>
  <summary>Details</summary>
Motivation: To describe how chemical evolution models enable galactic archaeology — reconstructing star formation histories from observed stellar and gas abundances — and to highlight the capabilities and uncertainties of this approach for understanding galaxy evolution across cosmic time.

Method: Adopts the "time-delay model" which interprets [X/Fe] vs. [Fe/H] relations based on different nucleosynthetic timescales of stellar progenitors relative to Fe; compares model predictions with observed abundances across morphological galaxy types.

Result: Shows how star formation histories can be reconstructed for spirals and ellipticals, with particular success for the Milky Way; traces the evolution from early to recent chemical evolution models, where the key difference lies in the improved observational constraints available for comparison.

Conclusion: Chemical evolution models are powerful for galactic archaeology and high-redshift galaxy predictions; future improvements will come from better observational constraints and refined model ingredients to further constrain galaxy evolution.
...
TL;DR: S-PLUS DR5 covers 4592 sq deg with 113M+ detections using a 12-filter system, including new Galactic disk coverage, improved photo-zs, and a catalog of 1706 cluster members in Hydra and Antlia, with evidence of a bridge connecting both clusters.


<details>
  <summary>Details</summary>
Motivation: To release the 5th data release of S-PLUS, expanding sky coverage (including the Galactic disk for the first time), improving data reduction and calibration, and providing value-added catalogs (photo-zs, classifications, masks) to enable studies from Solar System science to cosmology and large-scale structure.

Method: Observations with the T80-South robotic telescope using the Javalambre 12-filter system (5 broad + 7 narrow). Data products: FITS images, catalogs of fluxes/magnitudes/shapes for 113M+ detections, value-added catalogs with photo-zs, classifications, masks, extinction. Hydra/Antlia cluster analysis using spectroscopic and high-quality photo-zs up to 5×R200.

Result: 4592 sq deg across 2491 fields; 113M+ detections; first 110 sq deg along the Galactic disk; full coverage of Hydra Supercluster; updated catalog of 1706 cluster members in Hydra and Antlia; both clusters have similar Hα excess proportion vs. clustercentric distance, but Hydra has higher fraction near center; a spatial bridge connecting both clusters is detected.

Conclusion: S-PLUS DR5 provides a solid foundation for future scientific investigations ranging from Solar System studies to cosmology.
...
TL;DR: The study measures the fraction of Lya emitters (LAEs) that are radio-emitting AGN (1.77%) and the fraction of radio sources showing Lya emission (18.15%) at z~1.88–3.52 using HETDEX and LOFAR data. Both fractions increase with luminosity. No significant correlation is found between Lya and radio properties, suggesting Lya emission is primarily powered by star formation rather than direct AGN jet coupling.


<details>
  <summary>Details</summary>
Motivation: To understand the connection between radio AGN activity and Lya emission in galaxies at high redshift (1.88 < z < 3.52), specifically whether AGN jets significantly power or influence extended Lya emission.

Method: Cross-matched 55,109 HETDEX LAEs with 27,625 LOFAR radio sources to obtain 928 matched sources. Applied completeness corrections and measured fractions fAGN,radio (LAEs identified as radio AGN) and fLya (radio sources with Lya emission) as functions of luminosity.

Result: fAGN,radio = 1.77±0.04%, fLya = 18.15±0.14%. fAGN,radio increases from 0.4% to 9.7% with Lya luminosity; fLya rises from 0.7% to 55.8% with radio luminosity. No significant correlation between Lya luminosity and radio luminosity or spectral index. Lya line width correlates with Lya luminosity but not radio size.

Conclusion: Most Lya emission at z~1.88–3.52 is powered by star formation. Radio AGN activity is confined to a small, luminous subset (~1.8%). The lack of correlations between Lya and radio properties indicates Lya emission is governed primarily by host-galaxy gas properties, not direct AGN jet coupling.
...
TL;DR: The study investigates aliphatic-containing pyrene derivatives as carriers of the 3.4 μm emission band observed in space, identifying 1,2,3,6,7,8-hexahydropyrene as the primary contributor to the red component at 3.403 μm, using gas-phase IR spectra (373-673 K), empirical anharmonicity laws, Monte Carlo emission modeling, and comparisons with JWST Orion Bar observations.


<details>
  <summary>Details</summary>
Motivation: To refine the understanding of the contribution of aliphatic-containing PAH-like species to the 3.4 μm satellite emission band observed alongside the aromatic 3.3 μm PAH band in astronomical spectra.

Method: Mid-infrared spectra of gas-phase pyrene derivatives (dihydropyrene, tetrahydropyrene, hexahydropyrene, methylated pyrene, pyrene) were recorded at 373-673 K, analyzed with multi-component fitting, and empirical anharmonicity laws derived for temperature-dependent band evolution. These data were combined with Monte Carlo emission modeling to simulate spectra after UV absorption up to ~6 eV, then compared with JWST Orion Bar observations.

Result: 1,2,3,6,7,8-hexahydropyrene is identified as the carrier of the red component of the 3.4 μm band at 3.403 μm. 1-methylpyrene may contribute to the underlying plateau but lacks a strong IR band for clear detection.

Conclusion: State-of-the-art simulated spectra from laboratory experiments and modeling provide improved spectral assignments for the 3.4 μm emission feature, with hexahydropyrene as a key carrier. All experimental data are publicly available in the cosmicPAH-IRDB database.
...
TL;DR: EHT 2021 observations of blazar 3C279 reveal a compact core elongated orthogonal to the large-scale jet axis, with apparent superluminal motion up to 10c, Lorentz factors >10.3, and viewing angles <1°, indicating a sub-parsec scale jet bend toward the observer. Low brightness temperatures (~10^9-10^10 K) suggest optically thin 230 GHz emission. Possible bending mechanisms include ISM interaction, instabilities, magnetic reconnection, or binary precession, but current data cannot distinguish them.


<details>
  <summary>Details</summary>
Motivation: To resolve the innermost jet region of the blazar 3C279 at unprecedented angular resolution using EHT 2021 observations, and to investigate the intrinsic jet morphology, kinematics, and physical conditions at the jet base on sub-parsec scales.

Method: Event Horizon Telescope observations at 22-230 GHz across multiple epochs; geometric model fitting of reconstructed images to identify jet components and measure apparent speeds, brightness temperatures, and Lorentz factors.

Result: Compact core elongated nearly orthogonal to the large-scale jet axis; components with apparent speeds up to 10c; bulk Lorentz factors >10.3; viewing angles <1°; rest-frame brightness temperatures ~10^9-10^10 K.

Conclusion: The jet bends toward the observer on sub-parsec scales, producing strong relativistic beaming. Multiple possible mechanisms exist but cannot be distinguished with current VLBI temporal coverage; continued multifrequency VLBI monitoring is needed.
...
TL;DR: This paper presents the first application of Surface Brightness Fluctuations (SBF) to Euclid data, using the FAST-SBF code to measure distances to galaxies in the Fornax cluster, Perseus cluster, and NGC 6744 field from Early Release Observations. They calibrate the absolute fluctuation magnitude as a function of color and find reasonable agreement with literature distances, demonstrating the potential of Euclid for SBF-based distance measurement and stellar population studies.


<details>
  <summary>Details</summary>
Motivation: To demonstrate the feasibility and robustness of measuring SBF-based distances using Euclid imaging data, which is crucial for enabling precise redshift-independent distances from large-scale photometric surveys in the Euclid era.

Method: Applied the FAST-SBF code to measure stellar fluctuation amplitudes in the I_E band from Euclid ERO data of the Fornax cluster, Perseus cluster, and NGC 6744 dwarf satellite candidates. Calibrated the absolute fluctuation magnitude M_I_E as a function of (I_E - H_E) color for 15 Fornax galaxies, then tested this calibration on the other fields. Compared results against literature distances and SPoT simple stellar population models.

Result: Extracted robust SBF measurements despite Euclid's data reduction pipeline not being optimized for SBF. Found reasonable agreement with literature distances overall, with good agreement when FAST-SBF indicated robust measurements.

Conclusion: Euclid data can be used for SBF-based distance measurements, and SBF with Euclid has potential to probe underlying stellar populations of galaxies.
...
TL;DR: This paper analyzes the optical morphologies of 6211 low-mass star-forming galaxies (M*/M⊙ ~ 10^7–10^10, z<0.1) from the SAGAbg catalog using Legacy Surveys and STATMORPH. Non-parametric measures (Gini, M20, CAS) reveal that bulge strength is most reliable, g-band light is least concentrated, and flatter profiles correlate with lower mass and higher sSFR. Low-mass star-forming galaxies are predominantly disk-dominated, with bulges emerging in quenched systems above log(M*/M⊙)≳9.


<details>
  <summary>Details</summary>
Motivation: To use optical morphologies of low-mass galaxies as direct tracers of their assembly history and to constrain galaxy evolution models, leveraging high-completeness low-redshift data.

Method: Selected 6211 low-mass star-forming galaxies from SAGAbg (z<0.1), obtained griz-band Legacy Surveys images, computed non-parametric morphological measures (Gini, M20, CAS) via STATMORPH, and analyzed resolution/SNR effects and correlations with stellar mass and sSFR.

Result: Bulge strength is the most reliable measure; g-band light is least concentrated; M20 trends with stellar mass and sSFR show flatter profiles in less massive, higher-sSFR galaxies; Gini-M20 sequence links to the star-forming sequence with Sb/Sc/Ir morphologies dominant.

Conclusion: Star-forming low-mass galaxies predominantly exhibit disk morphologies, with bulges becoming more prominent in quenched systems at higher masses (log(M*/M⊙)≳9).
...
### [20] [Ultraviolet to Infrared Spectroscopy of the Type Ibn SN 2023tsz Suggests a Lower-mass Progenitor](https://arxiv.org/abs/2607.15342)
...
TL;DR: The paper presents observations and radiative-transfer modeling of Type Ibn SN 2023tsz, showing it is powered by ejecta-CSM interaction with a cold dense shell, best explained by a ~4 M⊙ helium star explosion with X-ray irradiation (~10^8 L⊙), supporting the binary interaction origin for some SNe Ibn.


<details>
  <summary>Details</summary>
Motivation: Type Ibn supernovae are important probes of late-stage mass loss and progenitor stripping in stripped-envelope explosions, as their spectra indicate interaction with dense, helium-rich, hydrogen-poor circumstellar material (CSM).

Method: Extensive ultraviolet-to-near-infrared spectrophotometry (including HST/STIS UV spectroscopy and ground-based optical/NIR follow-up) was obtained and compared to one-dimensional non-LTE radiative-transfer models of a 4 M⊙ helium-star explosion with an added X-ray irradiation field.

Result: The spectra show intermediate-width emission lines dominated by a cold dense shell (CDS). The best-fit models require L_X ≈ 10^8 L⊙, CDS radii of (1.5–2)×10^15 cm, velocities ~5×10^7 cm/s, and interaction powers of a few ×10^42 erg/s. At optical wavelengths, models shift from higher power/smaller radii at early times to lower power/larger radii at later times.

Conclusion: SN 2023tsz adds to evidence that at least some SNe Ibn arise from lower-mass helium stars whose final evolution is shaped by binary interaction.
...
### [21] [Observations of X-ray quasi-periodic eruptions](https://arxiv.org/abs/2607.15359)
*Thomas Wevers,Joheen Chakraborty,Erwan Quintin,Michal Zajaček,Margherita Giustini*

Main category: astro-ph.HE

TL;DR: This paper provides a comprehensive review of quasi-periodic eruptions (QPEs), a new class of repeating X-ray nuclear transients discovered in 2019, covering their observational characteristics, spectral/timing properties, host galaxy properties, links to tidal disruption events, and model constraints.


<details>
  <summary>Details</summary>
Motivation: QPEs represent a newly discovered class of repeating nuclear transients distinct from known modes of massive black hole variability, and a systematic overview of their observational properties is needed as the sample grows to 13 sources.

Method: Comprehensive review of X-ray spectral and timing properties of QPE eruptions, long-term evolution, quiescent emission, population-level trends, selection biases, host galaxy census, and evidence connecting QPEs to tidal disruption events.

Result: QPEs exhibit large-amplitude, quasi-regular eruptive variability; quiescent emission is described by thermally dominated compact accretion disks; strong connections exist between QPEs and tidal disruption events.

Conclusion: Key observational constraints on proposed QPE models are summarized, and future observational challenges and opportunities for understanding this emerging population of nuclear transients are outlined.
...
### [22] [Multimessenger prospects of quasi-periodic eruptions](https://arxiv.org/abs/2607.15360)
*Vojtěch Witzany,Alessia Franchini,Matteo Bonetti,Luca Broggi*

Main category: astro-ph.HE

TL;DR: This paper explores the potential for coincident detection of Extreme Mass Ratio Inspirals (EMRIs) both as Quasi-Periodic Eruptions (QPEs) in X-rays and as gravitational-wave sources for LISA, finding that current QPE periods place their GW signals outside LISA's sensitivity band, making coincident detection unlikely with existing catalogs, and recommending future searches for short-period QPEs as "golden" targets.


<details>
  <summary>Details</summary>
Motivation: To assess whether EMRIs can be detected simultaneously as QPEs (electromagnetic transients) and by LISA (gravitational waves), which would enable sky localization, standard siren measurements of Hubble constant, and insights into EMRI formation mechanisms and black hole environments.

Method: The paper analyzes the orbital periods of known QPEs relative to LISA's sensitivity band, evaluates selection biases in both QPE detection and LISA's observational capabilities, and discusses the parameter space where coincident detection could be feasible.

Result: Most known QPEs have orbital periods that place their gravitational-wave frequencies outside LISA's sensitivity band. Additionally, selection biases from both QPE detection methods and LISA instrument characteristics may preclude coincident detections.

Conclusion: Future efforts should expand QPE catalogs and specifically search for "golden" short-period QPEs that correspond to EMRIs falling within the LISA band, enabling multi-messenger synergies.
...
### [23] [Large-scale emission from gamma-ray binaries: the case of LS 5039](https://arxiv.org/abs/2607.15402)
*J. R. Martinez,V. Bosch-Ramon*

Main category: astro-ph.HE

TL;DR: The paper models large-scale emission from the gamma-ray binary LS 5039, finding that extended X-rays are best explained as synchrotron radiation from particles accelerated at the mixed-wind termination shock. Escaping protons could inject up to ~10^36 erg/s into Galactic cosmic rays at 0.1-1 PeV energies.


<details>
  <summary>Details</summary>
Motivation: LS 5039 shows extended (~1 pc-scale) X-ray emission that may arise from large-scale structures formed by wind interactions, but the origin and nature of this emission were unclear.

Method: Thermal and non-thermal emission modeled for five scenarios (three bubble scenarios with one-zone model, two bow-shock scenarios with multi-zone approach), including radiation from escaping particles, assuming particle acceleration at the mixed-wind termination shock.

Result: Extended X-rays are best explained as synchrotron radiation. Some scenarios predict detectable radio emission. Escaping particles may provide minor steady gamma-ray contribution in the powerful bow-shock scenario. Escaping protons (0.1-1 PeV) could inject up to ~10^36 erg/s into Galactic cosmic rays.

Conclusion: Gamma-ray binaries efficiently accelerate particles on large scales, producing broadband emission and PeV cosmic rays. Results can guide future multi-wavelength observations to constrain the large-scale interaction, age, and birthplace of LS 5039.
...
### [24] [Uncovering Hierarchical Sub-Population of Binary Black Holes](https://arxiv.org/abs/2607.15431)
*Muhammad Zeeshan,Richard O'Shaughnessy*

Main category: astro-ph.HE

TL;DR: The paper builds a multi-component mixture model for binary black hole populations using 259 gravitational wave events, finding that while some trends align with prior work (e.g., low spin at low mass), the model disagrees on spin isotropy—most components are isotropic—and shows hierarchical mass peaks without the expected spin-mass correlations from hierarchical formation.


<details>
  <summary>Details</summary>
Motivation: Evidence for multiple formation channels, including hierarchical formation, motivates a natively multi-component model to unveil subpopulations and formation mechanisms in the growing gravitational wave catalog of 259 binary black holes.

Method: A multi-component mixture model is built, where each component has independently recovered rate, mass, spin, and spin misalignment models (sharing a common redshift distribution). A power-law plus five successively higher mass Gaussians is used, tuned to avoid parameter degeneracies.

Result: Overall merger rates vs. mass and redshift trends match prior results. Previously identified spin trends (preferential alignment/low spin at low mass; large/isotropic spins at high mass) are only partially recovered: all components except the lowest mass are consistent with isotropy. A hierarchical spectrum of Gaussian mass peaks is found, but without expected spin-mass correlations from hierarchical formation.

Conclusion: Multi-component modeling reveals that spin isotropy holds for most components, contradicting earlier claims. The mass peak hierarchy lacks the predicted spin-mass coupling of naked hierarchical formation, suggesting more complex or alternative formation channels.
...
### [25] [A Multiwavelength Study of a Long-Duration VHE Flare from BL Lacertae with VERITAS](https://arxiv.org/abs/2607.15435)
...
TL;DR: First detection of a long-duration (~40 days) VHE flare from BL Lacertae by VERITAS, triggered by Fermi-LAT GeV activity. Multiwavelength observations and broadband modeling favor an SSC + EC emission model over a one-zone SSC model.


<details>
  <summary>Details</summary>
Motivation: To study the first long-duration VHE flare from BL Lacertae, investigate the physical processes driving prolonged high-energy emission, and constrain the emission model through multiwavelength observations.

Method: VERITAS observations (~9.8 hours over Sep–Dec 2022) triggered by Fermi-LAT GeV activity, combined with Swift, NuSTAR, optical, and radio data. Broadband spectral modeling comparing one-zone SSC vs. SSC + EC models.

Result: A ~28σ VHE detection was obtained. The flare lasted ~40 days, much longer than previously observed minute-to-day-scale VHE flares from BL Lacertae. The SSC+EC model is preferred over the one-zone SSC model.

Conclusion: BL Lacertae can sustain VHE flaring over month-long timescales, and the broadband emission requires an external inverse-Compton component in addition to synchrotron self-Compton emission.
...
### [26] [Triple radio flares from tidal disruption events: jet-wind collisions and the discovery of a third radio flare from AT2020vwl](https://arxiv.org/abs/2607.15438)
*Andrew Mummery,Adelle Goodwin,Colin Christy,Kate Alexander,Noah Franz*

Main category: astro-ph.HE

TL;DR: AT2020vwl shows a third radio flare consistent with a predicted collision between a jet and wind shock fronts in TDEs, supporting a unified framework for prompt and delayed radio flares.


<details>
  <summary>Details</summary>
Motivation: To test a theoretical framework predicting that TDEs with both prompt (wind-driven) and delayed (jet-driven) radio flares should exhibit a third flare when the jet catches up with the wind, using long-term radio monitoring of AT2020vwl.

Method: Long-term radio monitoring observations of AT2020vwl, forward modeling of two initial flares within a wind-jet framework, and comparison of predicted collision timescales with observed third flare timing. Predictions also generated for ASASSN-15oi and AT2024tvd.

Result: Discovery of a third radio flare in AT2020vwl coincident with the predicted collision epoch between jet and wind shock fronts. Predictions for ASASSN-15oi (possible weak flare/flattening) and AT2024tvd (imminent third flare).

Conclusion: The detection of a third flare in AT2020vwl supports the unified wind-jet framework for TDE radio flares, where prompt flares arise from super-Eddington winds and delayed flares from low-accretion-rate jets, with collision signatures providing a key observational test.
...
### [27] [Assessing the waveform systematics from parameter estimation to population inference with eccentricity](https://arxiv.org/abs/2607.15453)
*Muhammad Zeeshan,Richard O'Shaughnessy,Natalie Malagon,Katelyn J. Wagner*

Main category: astro-ph.HE

TL;DR: This paper analyzes 162 compact binaries from GWTC-4 using two eccentric waveform models (SEOBNRv5EHM and TEOBResumS-DALI) and quasi-circular models, finding that while source-parameter estimates are broadly consistent, small systematic offsets between eccentric models accumulate in hierarchical population inference—particularly affecting redshift evolution and effective spin distributions—with biases growing as ~√N, making waveform systematics increasingly important as catalogs expand. A synthetic data framework for eccentric population injection studies is also introduced.


<details>
  <summary>Details</summary>
Motivation: Eccentricity provides a powerful diagnostic for distinguishing compact binary formation channels, especially dynamically assembled systems. However, systematic differences between eccentric waveform models may propagate into population-level inferences, and this effect has not been systematically assessed on real catalog data.

Method: Analyzed 153 BBHs, 2 BNSs, and 7 NSBHs from GWTC-4 using two eccentric waveform models (SEOBNRv5EHM and TEOBResumS-DALI) and quasi-circular models. Compared source-parameter estimates and hierarchical population inferences. Introduced a synthetic data framework with RIFT posterior samples for injection studies.

Result: Eccentric models yield broadly consistent source parameters, but some events show subtle coherent differences. These accumulate in hierarchical inference, notably affecting redshift evolution and effective spin distributions. Biases scale approximately as √N with catalog size.

Conclusion: Waveform systematics are increasingly important for large catalogs; careful eccentric waveform modeling is essential for robust astrophysical population inference. The synthetic framework enables future eccentric population recovery studies.
...
### [28] [Implications of the UV/optical Plateau of AT2018cow](https://arxiv.org/abs/2607.15464)
*Wenbin Lu,Anthony L. Piro*

Main category: astro-ph.HE

TL;DR: The paper proposes that the long-lived UV/optical emission from AT2018cow (an LFBOT) originates from a super-Eddington wind photosphere and reprocessing by a thin outer disk, not a viscously-powered accretion disk. This model fits HST data equally well for accretor masses from 1.4 M☉ neutron star to ~100 M☉ black hole, but NIR-MIR free-free emission and recombination lines can break this degeneracy. The inferred disk parameters are consistent with a micro-tidal disruption event.


<details>
  <summary>Details</summary>
Motivation: To explain the puzzling long-lived (~5 yr) UV/optical plateau of AT2018cow, which cannot be easily accounted for by standard viscously-powered thin disk models without invoking an unusually massive black hole (≳200 M☉) that would violate X-ray constraints.

Method: Propose a model where UV/optical emission comes from the photosphere of a super-Eddington wind launched from the inner disk, plus irradiation/reprocessing by a geometrically thin outer disk. Fit the model to four-band HST photometry at t ~ 4 yr and test across a range of accretor masses (1.4 M☉ NS to ~100 M☉ BH).

Result: All accretor masses from NS to ~100 M☉ BH produce similarly good fits due to weak dependence of wind photospheric color temperature on accretor mass. NIR-MIR free-free emission differs by an order of magnitude across the mass range, offering a JWST discriminant. Recombination lines (HeII1640, Hα) also differ by accretor mass and disk composition.

Conclusion: The wind+thin-disk model resolves the tension with X-ray constraints and avoids requiring a ≳200 M☉ BH. The inferred parameters are consistent with a micro-tidal disruption event (tidal disruption or merger with a companion), where an initially thick disk transitions to a thin phase within the first year, evolving on a ~10 yr viscous timescale.
...
### [29] [High-Density Sound Speed and Post-Merger Dynamics](https://arxiv.org/abs/2607.15588)
*John Stroud,David Radice,Sanjay Reddy*

Main category: astro-ph.HE

TL;DR: This paper introduces a simplified parametrization to study how the speed of sound derivative in cold neutron star matter affects binary neutron star merger outcomes. Using the WhiskyTHC code and CoRe database simulations, the authors find correlations between the sound-speed slope parameter and post-merger gravitational-wave frequencies, identifying approximately EOS-independent relations that nonetheless retain sensitivity to high-density physics.


<details>
  <summary>Details</summary>
Motivation: The density dependence of the speed of sound in cold neutron star matter is poorly constrained yet central to determining the high-density equation of state (EOS). The direct impact of sound-speed in the neutron star core on observable multimessenger signatures has not been systematically explored.

Method: A simplified parametrization is introduced that suppresses microphysics while allowing controlled variation of the sound speed at supranuclear densities through its derivative with respect to baryon chemical potential. Fully relativistic BNS merger simulations are performed using the WhiskyTHC code, and gravitational-wave signals from the CoRe database employing more realistic EOS are also analyzed.

Result: Correlations are identified between the sound-speed slope parameter and key merger outcomes (remnant properties and post-merger GW frequencies). Approximately EOS-independent relations are found between the derivative of the sound speed and the peak post-merger gravitational-wave frequency, though these cannot be considered truly quasi-universal.

Conclusion: Post-merger gravitational waves retain measurable information about the EOS at the highest densities, but the remaining EOS dependence highlights the difficulty of isolating high-density physics, motivating targeted parameterized frameworks for interpreting future multimessenger observations.
...
### [30] [Stable X-ray reverberation lags in the black hole X-ray binary Swift J1727.8-1613](https://arxiv.org/abs/2607.15729)
*Wei Yu,Sinan Allak,Zi-Xu Yang,Xiao Fan,Andrea Santangelo,Tian-hao Xie*

Main category: astro-ph.HE

TL;DR: This paper studies X-ray reverberation lags in the black hole X-ray binary Swift J1727.8-1613 during its 2023 outburst using NICER observations. It finds that soft lag amplitude increases from low-hard to hard-intermediate state and then stabilizes, with the evolution largely explained by diminishing hard lag contamination rather than intrinsic geometry changes.


<details>
  <summary>Details</summary>
Motivation: To probe the inner accretion flow geometry across spectral states in a black hole X-ray binary by investigating the evolution of X-ray reverberation lags.

Method: NICER observations covering the low-hard state (LHS) and hard-intermediate state (HIMS) were analyzed using Fourier-based techniques to compute time lags and construct lag-frequency and lag-energy spectra. A frequency range where reverberation signal dominates was isolated to minimize contamination from hard lags and phase-wrapping effects.

Result: Soft lag amplitude increases rapidly from LHS to early HIMS, then stabilizes near 10 ms throughout HIMS. Reverberation-dominated lags show little dependence on Fourier frequency. Low-frequency lags transition from hard-lag dominated to soft-lag dominated.

Conclusion: The reverberation lag remains stable during HIMS, suggesting a relatively stable inner accretion geometry. The apparent evolution from LHS to HIMS is largely due to diminishing hard lags, not intrinsic light-travel time changes. This provides a clean case for studying reverberation over a broad frequency range.
...
### [31] [A cosmic-ray loaded nascent outflow driven by a massive star cluster](https://arxiv.org/abs/2607.15797)
...
TL;DR: Discovery of a cosmic-ray driven outflow from the massive star cluster Westerlund 1, evidenced by gamma-ray emission coincident with an atomic hydrogen cavity, suggesting such outflows may be common in young massive star clusters.


<details>
  <summary>Details</summary>
Motivation: Cosmic rays are theorized to drive outflows from star-forming galaxies and influence galaxy evolution, but direct evidence for cosmic-ray carrying outflows has been lacking. Additionally, the role of massive star clusters in accelerating cosmic rays is increasingly recognized.

Method: Observation of GeV gamma-ray emission coincident with an atomic hydrogen cavity near Westerlund 1, analyzed spatially and spectrally in connection with TeV gamma-ray emission from the cluster.

Result: The gamma-ray emission offset from TeV radiation but smoothly connected spectrally and spatially; implied energy density of co-accelerated protons and nuclei is at least an order of magnitude higher than the general interstellar medium.

Conclusion: Cosmic-ray loaded outflows may be a common feature of young massive star clusters, with implications for cosmic ray transport into the Galactic halo.
...
### [32] [Non-thermal emission from the vicinity of the magnetar CXOU J171405.7-381031](https://arxiv.org/abs/2607.15955)
*Manoel F. Sousa,Rita. C. Anjos*

Main category: astro-ph.HE

TL;DR: This paper presents a multiwavelength analysis of the magnetar CXOU J171405.7-381031 in SNR CTB 37B, modeling its broadband spectrum with leptonic and lepto-hadronic scenarios. The lepto-hadronic model better explains TeV emission via neutral-pion decay, and future CTAO observations can decisively test hadronic components.


<details>
  <summary>Details</summary>
Motivation: Magnetars are extreme neutron stars with ultra-strong magnetic fields and are promising candidates for high-energy particle acceleration. Understanding their emission mechanisms requires multiwavelength modeling.

Method: Multiwavelength spectral energy distribution modeling from radio to TeV using leptonic and lepto-hadronic scenarios, with particle populations constrained via Markov Chain Monte Carlo techniques.

Result: Both scenarios describe gamma-ray data acceptably. The leptonic model slightly underestimates H.E.S.S. highest-energy flux; the lepto-hadronic model improves description above ~10 TeV via neutral-pion decay. Required proton energy can be reduced if SNR interacts with dense medium. Magnetar wind nebula scenario is disfavored by morphology.

Conclusion: Future CTAO observations (~50 h) can constrain the proton cut-off energy, enabling a decisive test of hadronic emission in this region.
...
### [33] [Discovery of $γ$-Ray Pulsations from the Extreme-Spin-Down Millisecond Pulsar PSR J0435+3233](https://arxiv.org/abs/2607.16119)
*Mengqing Zhang,Shengbin Pei,Pengfei Zhang*

Main category: astro-ph.HE

TL;DR: Using ~17 years of Fermi-LAT data, we identify PSR J0435+3233 as a γ-ray millisecond pulsar with an extremely low γ-ray efficiency (~1.1×10⁻⁵) despite its exceptionally high spin-down luminosity (5.89×10³⁷ erg/s), providing new insights into MSP magnetospheric physics.


<details>
  <summary>Details</summary>
Motivation: The recent discovery of PSR J0435+3233, a millisecond pulsar with an unusually large period derivative (4.9×10⁻¹⁷ s/s) and high spin-down luminosity, motivated a search for its γ-ray counterpart to understand its emission properties.

Method: Analyzed ~17 years of Fermi-LAT observations, identified the γ-ray source 4FGL J0435.5+3232 as the counterpart (0.01° from radio timing position), and performed phase-resolved analysis using radio timing ephemeris to detect pulsations at ~6.8σ.

Result: γ-ray pulsations detected at ~6.8σ confidence, pulsed emission concentrated at rotational phase φ~0.44–0.69, γ-ray luminosity L_γ=6.26×10³² erg/s, and apparent efficiency η_γ~1.1×10⁻⁵ — exceptionally low despite the high spin-down power.

Conclusion: PSR J0435+3233 is confirmed as a γ-ray MSP; its extreme combination of high spin-down power and low γ-ray efficiency offers a new probe of particle acceleration, radiation beaming, and viewing geometry in millisecond pulsar magnetospheres.
...
### [34] [Impact of eccentricity and higher-modes on neutron star-black hole parameter estimation](https://arxiv.org/abs/2607.16135)
*Snehal Tibrewal,Aasim Jan,Aaron Zimmerman,Hsin-Yu Chen*

Main category: astro-ph.HE

TL;DR: This paper studies the impact of eccentricity on parameter estimation for neutron star-black hole (NSBH) gravitational wave signals. Using the SEOBNRv5EHM waveform model, the authors find that higher eccentricity significantly improves measurement precision for eccentricity itself, effective spin (χ_eff), and mass ratio (q), but shows no notable improvement for extrinsic parameters like luminosity distance and sky localization.


<details>
  <summary>Details</summary>
Motivation: Eccentricity in gravitational wave signals provides valuable information about binary formation and can improve parameter estimation, but its impact is not well-studied for neutron star-black hole (NSBH) systems, which produce longer in-band signals than binary black holes and may enable more precise eccentricity measurements.

Method: Systematic parameter-estimation study using injections simulated with the eccentric waveform model SEOBNRv5EHM, analyzing systems similar to GW200105_162426 across varying eccentricities.

Result: At e=0.25, eccentricity is recovered with 1σ uncertainty as low as 4×10⁻⁴. Constraints on χ_eff and mass ratio q improve by factors of ~13 and ~20, respectively, compared to quasi-circular case. No significant improvement is found for luminosity distance and sky localization.

Conclusion: Eccentricity in NSBH systems substantially improves inference of intrinsic parameters (eccentricity, spin, mass ratio) but does not significantly enhance extrinsic parameter constraints, likely due to degeneracy with higher-order modes.
...
### [35] [Eccentricity as a Magnifying Glass: Precision Population Inference Enabled by Eccentric Neutron Star--Black Hole Mergers](https://arxiv.org/abs/2607.16136)
*Alberto Salvarese,Hsin-Yu Chen,Aaron Zimmerman,Snehal Tibrewal*

Main category: astro-ph.HE

TL;DR: Eccentric NSBH mergers improve parameter measurements, enabling clearer identification of spin-orbit misalignment, tighter constraints on NS mass distributions, and better recovery of BH mass distributions, with dynamical formation channels testable by LVK O5.


<details>
  <summary>Details</summary>
Motivation: To understand how eccentricity-enhanced parameter measurements of NSBH mergers can improve the inference of their formation channels, since eccentricity may indicate alternative formation pathways beyond standard isolated binary evolution.

Method: The authors explore how eccentricity in NSBH mergers improves measurement precision of intrinsic parameters (masses, spins, χeff) and use these enhanced measurements to infer formation channel properties, including spin-orbit misalignment, NS mass distributions, BH mass distributions, and population-level eccentricity distributions.

Result: Eccentric NSBH detections allow identification of a spin-orbit misaligned event every ~2.5 detections (O5, isotropic population). Improved NS mass measurements tighten bounds on mass distributions. Metallicity-dependent BH mass recovery is improved. Population-level eccentricity distributions for dynamical formation are testable by end of O5.

Conclusion: Eccentricity-enhanced parameter measurements significantly improve the ability to distinguish between NSBH formation channels, particularly for spin-orbit misalignment, NS mass structure, and dynamical formation scenarios.
...
### [36] [X-ray polarization of Z-type neutron star low-mass X-ray binaries -- II. Spectropolarimetric analysis](https://arxiv.org/abs/2607.16140)
...
TL;DR: This paper presents detailed spectropolarimetric analysis of Z-type neutron star low-mass X-ray binaries using IXPE, NICER, and NuSTAR data. The study finds that Comptonization dominates X-ray emission and polarization, with polarization degree varying from ~6% on the horizontal branch to 3-4% on the normal branch. Disk polarization is lower (<3%) but higher than theoretical predictions, and polarization angles between disk and Comptonization are misaligned.


<details>
  <summary>Details</summary>
Motivation: To characterize the spectral states and polarization properties of Z-type NS-LMXBs across their color-color diagrams, building on previous model-independent analysis, and to understand the physical mechanisms driving X-ray emission and polarization in these systems.

Method: Spectropolarimetric analysis combining data from IXPE (polarimetry), NICER, and NuSTAR (spectroscopy) for each source on each branch (horizontal, normal, flaring). Continuum modeled with thermal accretion disk emission plus a harder Comptonized component, with reflection features (relativistically broadened Fe line) included for most sources.

Result: Comptonization dominates X-ray emission and polarization. PD varies from ~6% (HB) to 3-4% (NB), loosely constrained in FB. Disk PD <3%, higher than theoretical predictions. PA of disk misaligned and not perpendicular to Comptonization PA. No correlation found between polarization and inclination or reflected photon contribution.

Conclusion: Observed polarization levels are significantly higher than theoretical expectations for spreading/boundary layer configurations, and disk polarization exceeds predictions for electron scattering-dominated plane-parallel atmospheres. The misalignment between disk and Comptonization polarization angles suggests complex geometry in these systems.
