...
TL;DR: Multi-frequency study of radio halo in MACSJ0417 (z=0.445) using uGMRT, MeerKAT, and XMM-Newton. Halo extends ~1.75 Mpc, relics at 2.9 Mpc. Integrated spectra show power-laws (α~-1.3 halo, α~-1.6 relics). Radio surface brightness edge coincides with X-ray discontinuity. Strong radio-X-ray correlation (r~0.85), slope evolving from sublinear to linear with frequency. Results support turbulent re-acceleration model; hadronic model excluded. A minor off-axis merger (~6:1) along SE-NW axis drives turbulence powering the halo while preserving the cool core.


<details>
  <summary>Details</summary>
Motivation: To understand plasma processes in the intracluster medium (ICM) by studying diffuse non-thermal radio emission in galaxy clusters, specifically the radio halo in MACSJ0417, using a multi-frequency approach combining radio and X-ray observations.

Method: Multi-frequency radio observations with uGMRT (300-850 MHz) and MeerKAT (900-1670 MHz) combined with archival XMM-Newton X-ray data. Spectral index mapping, surface brightness correlation analysis, and morphological comparisons between radio and X-ray emission.

Result: The radio halo extends ~1.75 Mpc at 400 MHz with spectral index α~-1.3; two candidate relics at 2.9 Mpc with α~-1.6. A radio surface brightness edge ~43" SE of the centre coincides with an X-ray discontinuity. Resolved spectral maps show significant fluctuations and radial steepening. X-ray reveals elongated SE-NW morphology with ~11 keV hot regions. Strong radio-X-ray correlation (r~0.85) with slope evolving from sublinear to linear with frequency. Hadronic model excluded due to unrealistic cosmic-ray proton energy requirements.

Conclusion: The observed properties support the turbulent re-acceleration model for the radio halo. MACSJ0417 is likely undergoing a minor off-axis dissociative merger (mass ratio ~6:1) along the SE-NW axis, which preserves its cool core while driving turbulence that powers the giant radio halo.
...
TL;DR: A search for continuous gravitational waves from Scorpius X-1 using O4 LIGO data set upper limits below torque balance for 50-200 Hz, reaching h₀ ~5×10⁻²⁶ marginalized over inclination, corresponding to ellipticities as low as 3×10⁻⁶ at 200 Hz, challenging standard torque balance for hadronic EOS neutron stars.


<details>
  <summary>Details</summary>
Motivation: To detect or constrain continuous gravitational waves from Scorpius X-1, a promising target due to its known accretion torque that could sustain non-axisymmetric neutron star deformations, by searching deeper than previous analyses using newer, more sensitive LIGO data from the first part of O4.

Method: Applied the resampling version of the cross-correlation pipeline to LIGO O4 data, searching for GW signals in the frequency range 25-200 Hz (covering both triaxial and r-mode emission scenarios). Used hierarchical followup and additional later O4 data to vet outliers.

Result: Set upper limits below the standard torque balance level for 50-200 Hz, independent of inclination. Most sensitive limit h₀ ~5×10⁻²⁶ (marginalized) and ~2×10⁻²⁶ (best inclination). Sensitivity depth 70-75 Hz⁻¹/². Ellipticity constraints: 3×10⁻⁵ at 75 Hz and 3×10⁻⁶ at 200 Hz. All outliers ruled out as signals.

Conclusion: The results argue against torque balance for a hadronic-EOS neutron star in the 50-200 Hz spin range, though torque and EOS modeling uncertainties limit inference strength. The achieved sensitivity approaches deformations supportable by ordinary nuclear matter.
...
TL;DR: The paper identifies a new accretion flow regime called "Chimera" that achieves MAD-level magnetic flux and jet power without the typical bursty variability and morphology of standard MADs, demonstrating that MAD-like behavior depends on a dynamical coupling of multiple diagnostics and can be separated by accretion history and magnetic-flux supply.


<details>
  <summary>Details</summary>
Motivation: Black hole accretion flows are traditionally classified into SANE (weak-flux) and MAD (strong-flux) regimes. The authors seek to challenge this binary classification by exploring whether intermediate or hybrid states exist, and to understand what truly constitutes "MAD-like" behavior beyond simple horizon flux thresholds.

Method: Three-dimensional general relativistic magnetohydrodynamics (GRMHD) simulations comparing three regimes: a weakly magnetized SANE flow, a standard MAD, and a Chimera flow fed by a different reservoir of mass, angular momentum, and coherent magnetic flux.

Result: The Chimera flow maintains MAD-level horizon magnetic flux and launches a powerful electromagnetic jet without the bursty horizon-flux variability typical of standard MADs. SANE flows are hydrodynamically supported by gas pressure gradients, while MADs involve comparable magnetic pressure and tension. Chimera differs from standard MAD in density structure, funnel-wall geometry, mass-flow channels, radial force budget, and angular-momentum transport.

Conclusion: MAD-like behavior is not captured by any single diagnostic but by a dynamical coupling of multiple features. The Chimera demonstrates that these features can be disentangled by accretion history and magnetic-flux supply, suggesting a more nuanced classification beyond the binary SANE/MAD framework.
...
TL;DR: This paper investigates whether ultra-long gamma-ray bursts (ULGRBs) and luminous fast blue optical transients (LFBOTs) share a common origin from mergers of a massive helium core with a compact object. By reanalyzing SN 2011kl (associated with ULGRB 111209A) using an LFBOT model and comparing host galaxy environments, the authors find broad consistency but also differences (longer plateau, stronger UV suppression), supporting a shared progenitor for at least some ULGRBs and LFBOTs.


<details>
  <summary>Details</summary>
Motivation: To determine the physical connection between ULGRBs and LFBOTs, two rare classes of engine-driven transients, and test whether they share a common progenitor origin (mergers of massive helium cores with compact objects).

Method: Reanalyzed the optical counterpart of GRB 111209A/SN 2011kl using an analytical LFBOT model; compared host galaxy environments of five ULGRBs to those of LFBOTs and classical LGRBs.

Result: SN 2011kl is broadly consistent with an LFBOT origin (rapid, luminous, blue early emission) but shows a longer post-merger plateau emission (~2 weeks) and stronger UV suppression. ULGRB host galaxies, like LFBOTs and long GRBs, tend to be low-mass (<10^10 M☉) and actively star-forming.

Conclusion: Results support a shared progenitor for at least a subset of ULGRBs and LFBOTs.
...
TL;DR: EP250905a is a fast X-ray transient detected by Einstein Probe, best explained as an afterglow from a mildly off-axis structured jet at redshift z=2.714, with possible weak gravitational lensing (μ≈3.9) by a foreground galaxy at z=0.374.


<details>
  <summary>Details</summary>
Motivation: To constrain the physical origin of the FXT EP250905a, leveraging the Einstein Probe's discovery of ~100 FXTs per year to understand this diverse class of high-energy transients.

Method: Multi-wavelength temporal/spectral analysis (X-ray, optical, NIR, radio); spectroscopic redshift measurements of two nearby galaxies (G1 at z=0.374, G2 at z=2.714); gravitational lensing assessment using inferred Einstein radius of G1.

Result: Rapid X-ray fading; early optical emission fading below detection; no NIR or radio emission; G2 identified as likely host; possible lensing magnification (μ≈3.9) by G1 with θ_E≈1.9 arcsec and angular separation of 2.56 arcsec.

Conclusion: The broadband data are best explained as a mildly off-axis structured jet afterglow at z=2.714, with consistent interpretation allowing for weak gravitational lensing.
...
TL;DR: This paper presents data products and processing results from the SMART survey (140-170 MHz), including detections of hundreds of known pulsars in the southern sky, many first-time detections below 400 MHz, along with measurements of dispersion measures, rotation measures, and mean flux densities, to serve as a low-frequency reference for SKA-Low.


<details>
  <summary>Details</summary>
Motivation: To address the difficulties in handling large voltage data volumes (4 PB) and processing challenges for routine pulsar detections, and to provide a low-frequency catalogue of detectable pulsars in the southern sky as a valuable reference for SKA Observatory (SKAO) science verification, as construction of SKA-Low ramps up.

Method: The SMART survey uses voltage recording with long dwell times and high time/frequency resolution at 140-170 MHz, covering the entire sky south of +30° declination. Data processing is done in multiple phases: initial shallow surveys reported earlier, followed by re-detection processing of known pulsars. Data products include pulse profiles, time series, multi-channel folded archives, and measurements of dispersion measures, rotation measures, and mean flux densities.

Result: Hundreds of known pulsars in the southern sky have been re-detected, many for the first time below 400 MHz. The survey has accumulated 4 PB of data, and the data products are periodically updated as more detections come from ongoing processing.

Conclusion: The growing low-frequency (140-170 MHz) catalogue of pulsar detections and measurements will be invaluable for population studies, survey simulations, emission beam models, refining interstellar medium models (electron densities, turbulence distribution), and forecasting detection prospects and survey yield for SKA-Low pulsar surveys.
...
TL;DR: The paper develops a semi-analytical hybrid model coupling magnetar central engine and circumstellar interaction to explain superluminous supernova light curves, showing diverse morphologies and reducing extreme nickel or explosion energy requirements.


<details>
  <summary>Details</summary>
Motivation: SLSNe are typically modeled as powered either by a central engine (magnetar) or by strong CSM interaction, but these mechanisms may be dynamically coupled. Existing models treat them separately, potentially missing coupled physics and requiring extreme nickel masses or explosion energies.

Method: A semi-analytical hybrid model that couples magnetar wind injection (inflating a hot bubble within ejecta), radiative diffusion, and circumstellar interaction (CSI) shock dynamics. The model tracks energy conversion and the potential catch-up of the magnetar-driven shock with the CSI region.

Result: The model produces diverse SLSN light-curve morphologies: luminous interaction-powered peaks, asymmetric post-peak declines, and late-time emission from delayed magnetar-powered radiation leakage. It reduces the extreme nickel-mass or initial explosion-energy requirements seen in single-mechanism models.

Conclusion: A coupled magnetar + CSM interaction model provides a more physically consistent framework for SLSNe, explaining diverse light-curve shapes while alleviating the need for extreme energy or nickel-mass assumptions.
...
TL;DR: This paper analyzes SN 2024abfl, a low-luminosity Type IIp supernova (LLSN) with a uniquely steep post-plateau luminosity drop, and demonstrates via MESA/STELLA simulations that suppressed ejecta mixing during shock breakout can reproduce this light curve feature, suggesting limited mixing as a distinguishing mechanism in LLSNe.


<details>
  <summary>Details</summary>
Motivation: To understand the mechanism behind the unusually steep post-plateau luminosity drop in the LLSN SN 2024abfl, and more broadly to investigate how LLSNe differ mechanistically from typical Type IIp supernovae.

Method: Custom pipeline using MESA (stellar evolution) and STELLA (radiation transport) to simulate light curves; suppressed mixing mechanisms during shock breakout explored as a candidate explanation for the steep drop-off.

Result: Turning off mixing during shock breakout reproduces the flat plateau and steep luminosity drop into the radioactive tail, using previously proposed progenitor mass, radius, and explosion energy parameters.

Conclusion: This proof-of-concept suggests that suppressed ejecta mixing may be a key factor distinguishing LLSNe from typical Type IIp SNe, and warrants further investigation across LLSN candidates.
...
TL;DR: Analysis of Fermi-LAT data reveals a 20 GeV halo component consistent with dark matter annihilation, with best-fit WIMP masses of ~0.55 TeV (W+W-) and ~0.72 TeV (bbar), and cross-section ~1e-24 cm3/s, facing 4-5x tension with dwarf spheroidal limits that can be resolved via low-velocity-enhanced annihilation models.


<details>
  <summary>Details</summary>
Motivation: To independently verify and extend a recent claim of a spherically symmetric 20 GeV halo in Fermi-LAT Galactic diffuse emission, and to assess its consistency with dark matter interpretations by comparing against dwarf spheroidal galaxy constraints and exploring alternative particle models.

Method: Cell-aggregated analysis (reproducing prior work) and pixel-level likelihood on native 0.125° maps with energy-dependent PSF forward folding and source masking. Fits to prompt s-wave annihilation spectra, p-wave annihilation, decay models, and velocity-enhanced annihilation (resonant Sommerfeld/Breit-Wigner).

Result: Both methods reproduce the 20 GeV halo spectrum; pixel-level normalization ~20% above cellwise fit across NFW emissivity scalings. Best-fit masses: m_χ~0.55 TeV (W+W-), 0.72 TeV (bbar) with ⟨σv⟩~1e-24 cm3/s. 4-5x tension with dSph limits (widening to R~1.6-9.3 with systematics). p-wave misses relic abundance by ~7 orders. Decay disfavored by IGRB. Only low-velocity-enhanced annihilation (Sommerfeld/Breit-Wigner) provides ~45x boost needed.

Conclusion: The 20 GeV halo is a high-latitude feature distinct from the inner-Galaxy excess, consistent with sub-TeV WIMP annihilation. S-wave interpretation is viable after accounting for systematics. Fully resolving dwarf tension requires fine-tuned resonant velocity-enhanced annihilation models.
...
TL;DR: First detection of radio pulsations from PSR J2238+5903, a gamma-ray pulsar coincident with TeV source 1LHAASO J2238+5900, using FAST. The faint pulsar ($S_{1250}\simeq3\,\mu$Jy) has $P=162.76568$ ms, $\mathrm{DM}=247.5\pm3.0$ pc cm$^{-3}$, implying $d_{\rm DM}=7.4\pm3.9$ kpc. At this distance, the TeV source has a $\sim132$ pc diameter and $L_{\rm TeV}\simeq7.1\times10^{34}$ erg s$^{-1}$ (8\% of spin-down power), enabling assessment of its nature as a relic PWN or TeV halo.


<details>
  <summary>Details</summary>
Motivation: To establish a pulsar-specific distance constraint for the TeV source 1LHAASO J2238+5900 via DM measurement, enabling discrimination between a young relic pulsar wind nebula (PWN) and a TeV halo transition system.

Method: 3000 s FAST L-band observation; FFT-based and Fast Folding Algorithm searches for periodic signals; radiometer equation for flux density; DM-to-distance via Galactic electron-density models.

Result: Detected weak periodic signal at $P=162.76568$ ms, $\mathrm{DM}=247.5\pm3.0$ pc cm$^{-3}$, $S_{1250}\simeq3\,\mu$Jy. Distance $d_{\rm DM}=7.4\pm3.9$ kpc. TeV source containment diameter $\sim132$ pc, $L_{\rm TeV}\simeq7.1\times10^{34}$ erg s$^{-1}$ (8\% $\dot{E}$).

Conclusion: The DM-derived distance provides the first pulsar-specific constraint for evaluating whether 1LHAASO J2238+5900 is a young relic-PWN/TeV-halo transition system.
...
TL;DR: This study investigates whether the presence of active galactic nuclei (AGN) in Type Ia supernova (SN Ia) host galaxies introduces systematic uncertainties in Hubble residual measurements, finding no significant effect for low-redshift (z < 0.15) SNe Ia from the ZTF DR2 sample.


<details>
  <summary>Details</summary>
Motivation: Type Ia supernovae are key cosmological distance indicators, but systematic uncertainties from their astrophysics and environmental links remain poorly understood. As observational samples grow, these systematics become increasingly important, motivating the need to investigate potential biases such as AGN presence in host galaxies.

Method: The study uses the Zwicky Transient Facility (ZTF) SN Ia DR2 sample to compare Hubble residuals of SNe Ia hosted by galaxies with and without active galactic nuclei, focusing on the low-redshift regime (z < 0.15).

Result: The presence of AGNs in some SN Ia host galaxies does not produce a significant systematic effect on the measured Hubble residuals at low redshifts (z < 0.15).

Conclusion: AGN activity in host galaxies is not a major source of systematic uncertainty for SN Ia cosmology in the low-redshift regime, though further investigation may be needed at higher redshifts.
...
TL;DR: Reanalysis of SN 2015da reveals Hα emission site switches from circumstellar to unshocked ejecta around day 90, enabling late-time ejecta velocity recovery and dust formation localization. The supernova exploded with ≥4×10^51 erg inside a ~14 Msun circumstellar envelope, with mass loss rate of 0.035 Msun/yr over 400 years pre-explosion.


<details>
  <summary>Details</summary>
Motivation: To clarify ambiguous issues in the observational data of type IIn supernova SN 2015da by revisiting existing observations and resolving inconsistencies in interpreting the Hα emission source and circumstellar interaction.

Method: Reanalysis of observational data, including Hα emission site identification (switching from circumstellar matter to unshocked ejecta at ~day 90), bolometric light curve and expansion velocity modeling combined with circumstellar interaction modeling.

Result: The supernova explosion energy is ≥4×10^51 erg; the circumstellar envelope mass is ~14 Msun; the derived circumstellar density is consistent with Thomson optical depth from Hα modeling on day 46; the average mass loss rate is 0.035 Msun/yr over 400 years prior to explosion.

Conclusion: The revised picture of Hα emission switching from circumstellar to unshocked ejecta resolves ambiguities and provides consistent constraints on explosion energy, ejecta velocity, dust formation location, and progenitor mass-loss history.
...
TL;DR: This paper derives a steady-state warped-disk equation in the full Kerr spacetime, applicable to both Kerr black holes (a ≤ 1) and naked singularities (a > 1), finding that tilt profiles show distinct inner humps for naked singularities absent for black holes, which may aid in distinguishing the nature of the central object when combined with disk regime constraints.


<details>
  <summary>Details</summary>
Motivation: To study the tilt dynamics of thin, viscous accretion disks around spinning collapsed objects without relying on slow-spin or weak-field approximations, and to explore whether tilt features can help distinguish Kerr black holes from Kerr naked singularities.

Method: Derived a steady-state warped-disk equation in full Kerr spacetime using Pringle's framework, incorporating exact Keplerian and Lense-Thirring precession frequencies, valid for all Kerr parameter a. Analytical and numerical solutions obtained under realistic boundary conditions in the diffusive regime.

Result: Significant deviations from slow-spin approximations are found in the inner disk. For Kerr naked singularities (a > 1), the tilt profile exhibits distinct inner humps near the radius where specific angular momentum vanishes, a feature absent for Kerr black holes (a ≤ 1).

Conclusion: While the hump feature alone cannot uniquely distinguish Kerr BHs from naked singularities, combining it with constraints on the disk regime may provide a potential observational handle to probe the nature of the accreting compact object, with implications for interpreting X-ray spectral, timing, and polarization observations.
...
TL;DR: SACRA-K is a performance-portable numerical relativity code ported from Fortran SACRA-MPI to C++ with Kokkos library, validated across binary black hole, black hole neutron star, and binary neutron star configurations, showing waveform discrepancies below detector distinguishability thresholds, bitwise π symmetry preservation, and ~10x speedup on NVIDIA A100 or AMD MI300A accelerators vs CPU-based Fortran code.


<details>
  <summary>Details</summary>
Motivation: To create a performance-portable numerical relativity code that can run efficiently across different hardware architectures (CPU, NVIDIA GPU, AMD APU) while preserving the physics and numerical methods of the established SACRA-MPI Fortran code.

Method: Ported SACRA-MPI from Fortran to C++ using the Kokkos performance portability library, retaining BSSN spacetime evolution with Z4c constraint propagation, box-in-box Berger-Oliger adaptive mesh refinement, and high resolution shock capturing for general relativistic hydrodynamics.

Result: Waveform discrepancies below scatter among independent codes and resolution-dependent variation, at or below gravitational-wave detector distinguishability threshold; exact bitwise π symmetry preservation; second-order convergence of binary neutron star merger gravitational wave phase; ~10x speedup on A100 or MI300A vs CPU Fortran; scaling up to 256 accelerator devices.

Conclusion: SACRA-K successfully achieves performance portability while maintaining accuracy and numerical fidelity, offering substantial speed improvements on modern accelerator architectures.
...
TL;DR: New XRISM observations of M82's hot wind reveal velocity dispersion that cannot be explained by a supernova-driven free-wind model alone, requiring additional broadening from supersonic (Mach 1.71-3.14) non-thermal motions in the starburst's central region, suggesting energy diversion to magnetic fields and cosmic rays.


<details>
  <summary>Details</summary>
Motivation: To understand the driving mechanism of the multiphase outflow in the starburst galaxy M82 by testing whether a supernova-driven free-wind model can explain the hot wind energetics, which have been poorly constrained until XRISM provided the first direct measurements of temperature and velocity dispersion.

Method: The authors generated a suite of highly idealized hydrodynamic simulations varying energy and mass loading of the starburst, then constructed mock spectra to compare directly against the new XRISM observational constraints on the hot wind's temperature and velocity dispersion.

Result: The observed velocity dispersion cannot be replicated using the free-wind model alone; extra broadening is required, interpreted as non-thermal motions in the driving region of the starburst with Mach 1.71-3.14 (supersonic).

Conclusion: Supersonic motions in the hot gas of M82's central region are unexpected, implying that a significant fraction of the supernova energy that should heat the gas is instead diverted to other processes such as amplifying magnetic fields and driving cosmic rays.
...
TL;DR: This study quantifies radial mixing in exoplanet hosts using Gaia DR3, 2MASS, AllWISE, and Galactic chemical enrichment models. Giant-planet hosts originate in the inner Galaxy, brown-dwarf hosts span broader radial ranges, and rocky-only systems show smaller excursions. Outward-migrators host more compact outer companions. Older ages of rocky and rocky+giant hosts make them useful for habitability studies.


<details>
  <summary>Details</summary>
Motivation: To understand the connection between exoplanet host stars' birth environments, their orbital evolution through the Galaxy, and how these factors influence planetary architectures and Galactic habitability.

Method: Cross-matched Encyclopaedia of Exoplanetary Systems with Gaia DR3 astrometry, 2MASS and AllWISE infrared photometry; integrated stellar orbits using Galpy; inferred birth radii via Galactic chemical enrichment models combined with a generalized additive model from prior work.

Result: Giant-planet hosts preferentially trace inner-Galaxy birth sites; brown-dwarf hosts span broader radial displacements; rocky-only systems show smaller excursions and less concentrated birth radii; outward-migrators host more compact outer companions than inward-migrators; older ages found in rocky and rocky+giant hosts, especially outward migrators; no clear connection between radial displacement and planet multiplicity.

Conclusion: Planet-hosting systems can survive significant Galactic perturbations, but whether their architectures retain causal imprints of this evolution remains uncertain. Rocky and rocky+giant hosts (particularly outward migrators) serve as useful reference populations for future habitability and technosignature searches.
...
TL;DR: Using ASTRID and TNG300 simulations, the paper tracks massive black holes from z=2 to z=0.5, showing that central BHs follow a tight, redshift-invariant M_BH-M_* relation, while departures trace distinct evolutionary channels: mergers/quenching for high-mass centrals, tidal stripping for overmassive satellites, and inefficient dynamical friction for undermassive wandering BHs.


<details>
  <summary>Details</summary>
Motivation: To understand how the distribution of systems in the M_BH-M_* plane encodes the integrated growth of galaxies and their central black holes, as well as the processes that shape their evolution, by tracking BHs themselves (including central, satellite, and wandering populations) rather than their original host galaxies.

Method: The study uses the ASTRID and TNG300 cosmological simulations, tracking massive BHs from z=2 to z=0.5 (spanning 5.3 Gyr). Unlike most previous studies, they follow individual BHs rather than their original host galaxies, capturing central BHs, BHs in satellites, and off-nuclear wandering BHs.

Result: Central BHs evolve along a tight, nearly redshift-invariant M_BH-M_* relation consistent with local empirical constraints and variable AGN measurements. High-mass central BHs grow via mergers and quench hosts through AGN kinetic feedback. Tidal stripping moves satellites to lower M_* at fixed M_BH, producing overmassive BHs. Wandering BHs in ASTRID are undermassive relative to hosts with minimal accretion/merger growth.

Conclusion: A BH's location in the M_BH-M_* and specific BH accretion rate-specific star formation rate planes is a fossil record of its dynamical, accretion, and feedback history, with different populations (central, satellite, wandering) occupying characteristic regions.
...
TL;DR: Using eROSITA All Sky Survey data and Legacy Survey DR10, this paper constructs a large catalogue of X-ray AGN in low-redshift galaxies (including low-mass ones, logM*/Msol<10). It identifies 874 X-ray AGN in low-mass galaxies, constrains specific accretion rate distributions via Bayesian methods, finds a break at high λ_SAR suggesting Eddington-limited growth, and reports a ~1% cumulative AGN fraction for low-mass galaxies above λ_SAR>10^-3, providing mass-dependent insights into AGN accretion history.


<details>
  <summary>Details</summary>
Motivation: To probe rare, highly-accreting AGN and low-mass galaxies as local analogues of early-Universe galaxies, and to constrain the specific accretion rate distribution and AGN fraction in the low-mass regime, which remains unexplored.

Method: Combined four-pass eROSITA All Sky Survey X-ray data with Legacy Survey DR10 multi-wavelength catalogues (~5.35 million galaxies, 0.03<z<0.2). Used rigorous cleaning/validation of X-ray aperture photometry and host-galaxy associations, and a Bayesian framework to constrain p(logλ_SAR | M*, z).

Result: Identified 874 X-ray AGN in low-mass galaxies, mostly newly discovered. Detected a break at high λ_SAR (potential Eddington-limited growth). Cumulative AGN fraction ~1% for low-mass galaxies above λ_SAR>10^-3.

Conclusion: The specific accretion rate distributions reveal a nuanced, mass-dependent view of AGN growth and accretion history, which should be incorporated into future modelling. The firm lower limit on black hole occupation fraction in low-mass galaxies is established.
...
TL;DR: Boötes III is an ultra-faint dwarf galaxy with a velocity dispersion (~1.7 km/s) six times smaller than previously reported, placing it among tidally disrupting dwarfs like Antlia II and Crater II. It follows a highly eccentric, polar orbit around the Milky Way+LMC and is likely actively losing its dark matter or hosts a cored density profile, providing insights into dark matter physics.


<details>
  <summary>Details</summary>
Motivation: To provide updated systemic properties of Boötes III using S$^5$ data, resolving a previously anomalously high velocity dispersion, and to assess its tidal disruption status, dark matter content, and relationship to surrounding stellar streams.

Method: Identification of 21 high-probability members from S$^5$; velocity dispersion and metallicity measurement; orbit integration in a MW+LMC potential; comparison of tidal radius to half-light radius; simulation of tidal streams.

Result: Velocity dispersion σ_v = 1.69^{+1.03}_{-0.85} km/s (vs. previous 10.7±3.5 km/s); mean [Fe/H] = -2.34±0.11; highly eccentric (e~0.8), polar (i~89.5°) orbit; recent pericenter ~0.14 Gyr ago at ~9.5 kpc; tidal radius at pericenter ~164 pc, only ~0.35 of half-light radius.

Conclusion: Boötes III is tidally disrupting, has likely lost most of its dark matter or hosts a cored density profile, making it a useful probe of dark matter. The Styx stream is a candidate tidal tail but sensitive to MW/LMC mass assumptions; deeper spectroscopy is needed to confirm this association.
...
TL;DR: Using high-resolution N-body simulations of MBHBs from IllustrisTNG cosmological mergers, this paper finds highly eccentric binaries with short coalescence timescales (~1 Gyr), provides scaling relations for subgrid models, and shows consistency with PTA observations.


<details>
  <summary>Details</summary>
Motivation: To robustly interpret PTA gravitational wave background signals, a better understanding of MBHB merger timescales and their connection to host galaxy properties is needed, especially since observed amplitudes appear higher than standard model predictions.

Method: MBHBs are selected from IllustrisTNG cosmological galaxy mergers, re-simulated at high resolution using the N-body code Griffin to resolve dynamical friction and stellar hardening, then evolved to coalescence via a semi-analytical model.
...
Conclusion: The short coalescence timescales imply efficient binary evolution, consistent with current PTA constraints, and the derived scaling relations provide a framework for subgrid prescriptions in cosmological simulations.
...
TL;DR: The paper probabilistically classifies 251,413 LOFAR radio sources using DESI spectroscopy into star-forming galaxies, radio-quiet AGN, low-excitation radio galaxies (LERGs), and high-excitation radio galaxies (HERGs). At 90% probability threshold, they identify 68,820 SFGs, 32,288 RQ AGN, 35,210 LERGs, and 3,085 HERGs — the largest such classified sample. They find LERGs typically accrete below 1% Eddington limit while HERGs exceed it, and identify a peculiar high-accreting LERG subset with star-forming features.


<details>
  <summary>Details</summary>
Motivation: To distinguish between star formation and AGN-driven radio emission in the faint radio-source population, as both processes are key to galaxy evolution but difficult to separate, and to enable robust classification for upcoming SKA-era studies.

Method: Probabilistic classification of 251,413 LoTSS DR2 radio sources using DESI DR1 spectroscopy, employing four diagnostic methods: (i) radio excess relative to star formation, (ii) BPT diagram, (iii) modified Mass Excitation (MEx) diagram, and (iv) [OIII]5007 equivalent width. Monte Carlo methods estimate classification probabilities for SFG, RQ AGN, LERG, or HERG.

Result: At >90% probability: 68,820 SFGs, 32,288 RQ AGN, 35,210 LERGs, and 3,085 HERGs — the largest high-confidence spectroscopically classified radio sample. LERGs accrete below 1% Eddington, HERGs above it. A rare high-accreting LERG subset shows star-forming features in stacked spectra.

Conclusion: Large spectroscopic samples enable robust probabilistic classification of radio sources, revealing distinct accretion modes between LERGs and HERGs, and uncovering subtle subpopulations (e.g., high-accreting LERGs with star formation). This work provides a foundation for radio-source population studies in the SKA era.
...
TL;DR: This study uses IllustrisTNG cosmological simulations and photoionisation models to show that current emission line diagnostics (e.g., HeII) can detect galaxies dominated entirely by Population III stars but fail when hybrid Pop III/Pop II populations exist, introducing spectral degeneracies that mask Pop III signatures in most realistic galactic environments.


<details>
  <summary>Details</summary>
Motivation: Identifying the first generation of metal-free (Pop III) stars is a central challenge in astrophysics, but realistic galaxies may host hybrid Pop III/Pop II stellar populations, complicating the interpretation of observed spectra and the detectability of Pop III signatures.

Method: Select galaxies with varying Pop III-to-total mass ratios from IllustrisTNG cosmological simulations; compute integrated spectra using self-consistent photoionisation models that adopt local physical conditions from the simulations; analyze resulting emission line diagnostics.

Result: Emission line diagnostics strongly depend on relative Pop III contribution; current diagnostics succeed only for galaxies dominated totally by Pop III stars but fail when Pop II stars contribute significantly, introducing degeneracies in spectral interpretation.

Conclusion: Existing emission line diagnostics are insufficient for hybrid systems; additional methods that account for mixed stellar populations are needed to reliably detect Pop III stars during and after the epoch of reionization.
...
TL;DR: The paper introduces LSTM-MDNz, a deep learning framework combining LSTM networks and Mixture Density Networks to improve photometric redshift estimation and uncertainty quantification for LSST. It outperforms BNN baselines by ~10% in point estimates and ~20% in outlier reduction, with well-calibrated PDFs enabling high-purity catalog construction.


<details>
  <summary>Details</summary>
Motivation: Accurate photo-$z$ estimation and robust uncertainty quantification are critical for LSST's precision cosmology goals. Traditional ML methods struggle with multimodal redshift PDFs and color-redshift degeneracies, necessitating a more expressive approach.

Method: LSTM-MDNz treats multi-band photometry as wavelength-ordered sequences, using LSTM networks to capture non-linear SED correlations, then employs a Mixture Density Network (MDN) to model posterior PDFs via Gaussian mixture models (GMMs).

Result: The model achieves ~10% improvement in point-estimation accuracy (RMSE, MAE, scatter, σ_NMAD) and ~20% reduction in outlier rates over the BNN baseline. Uniform PIT distribution confirms well-calibrated outputs. Excluding ~4% of low-confidence samples reduces outlier rate by ~48%.

Conclusion: LSTM-MDNz provides superior photo-$z$ accuracy and uncertainty calibration, meeting the stringent data quality requirements for next-generation cosmological surveys like LSST.
...
TL;DR: Disagreements between different electron density diagnostics in ionized nebulae (up to 100x) are resolved not by atomic data errors or ionization stratification, but because each diagnostic is sensitive to a different part of a broad density distribution; nebulae lack a single electron density, requiring revision of mass, pressure, abundance, and energetics estimates based on the single-density assumption.


<details>
  <summary>Details</summary>
Motivation: A longstanding puzzle in astrophysics: different density-sensitive emission lines applied to the same gas return electron densities that disagree by up to two orders of magnitude, previously attributed to distinct ionization zones or imperfect atomic data.

Method: The authors demonstrate that each density diagnostic is tuned to a particular density range; when a nebula contains gas across a wide range of densities, each line reports the part of that range it is most sensitive to, rather than measuring a representative average density.

Result: The discrepancy is resolved by a simple relation between the density each line returns and the density it is most sensitive to. This relation holds from individual H II regions to galaxies and reveals that ionized nebulae contain far more dense gas than any single diagnostic implies.

Conclusion: Ionized nebulae have no single electron density; they possess a broad density distribution. Mass, pressure, abundance, and energetics estimates built on the single-density assumption must be reconsidered across all scales, from nearby star-forming regions to galaxies across cosmic time.
...
TL;DR: CARPP is a publicly available fitting package that generates optimized core density and temperature profiles of dense molecular cores using parameterized radiative transfer calculations and multi-wavelength dust continuum data, achieving high accuracy and serving as a balanced alternative between simplified SED analyses and complex 3D modeling.


<details>
  <summary>Details</summary>
Motivation: Density profiles of dense molecular cores are important indicators of their physical and evolutionary states, and multi-wavelength dust continuum data offers excellent constraints, motivating the need for a practical, standardized tool to analyze them.

Method: CARPP assumes spherical symmetry, adopts physically motivated parametric forms for density and temperature profiles, performs parameterized radiative transfer calculations, and fits dust continuum data to generate optimized profiles.

Result: Tests on synthetic data show averaged relative errors <20% for seven parameters when noise conditions satisfy RMS noise/peak flux < 0.025×(r₀/resolution)+0.05. Real-data demonstration classified TMC-1C as a Bonnor-Ebert sphere and Ori2-2 as a collapsing envelope with power-law-dominated profile.

Conclusion: CARPP is a powerful, versatile tool for classifying the dynamical states of individual cores, offering an optimal balance between physical fidelity and computational efficiency.
...
TL;DR: The paper presents a direct measurement of the Lyα escape fraction ($f_{\rm esc}^{\rm Lyα} = 0.106^{+0.066}_{-0.044}$) for Hα emitters at z≈6.2 using JWST/NIRCam F470N and Subaru/HSC NB872 imaging. The median escape fraction agrees with previous measurements, shows no significant dependence on Hα luminosity, and correlates positively with Lyα equivalent width while negatively with UV slope and UV size, suggesting compact, low-attenuation star-forming components drive escape fraction variations.


<details>
  <summary>Details</summary>
Motivation: To directly measure the Lyα escape fraction during the epoch of reionization (z≈6.2) by simultaneously observing Lyα and Hα through a unique pair of narrow-band filters, and to understand which galaxy properties govern Lyα escape and its implications for the ionizing photon budget during reionization.

Method: Combined JWST/NIRCam F470N narrow-band imaging (tracing Hα at z≈6.2) with Subaru/HSC NB872 imaging (tracing Lyα). Selected 84 HAEs from F470N excess; 56 with reliable NB872 photometry, 19 detected in Lyα at >2σ. Performed completeness-weighted stacking to derive median $f_{\rm esc}^{\rm Lyα}$ and analyzed correlations with galaxy properties (Hα luminosity, Lyα EW, UV slope β, UV/optical sizes, dust attenuation).

Result: Median $f_{\rm esc}^{\rm Lyα} = 0.106^{+0.066}_{-0.044}$ at z≈6.2. No significant dependence on Hα luminosity. Positive correlation with Lyα equivalent width, negative correlation with UV slope β and rest-frame UV size. No significant correlation with E(B-V) or rest-frame optical size.

Conclusion: The escape fraction agrees with other recent z~6 measurements. Luminous HAEs may contribute importantly to the ionizing photon budget during reionization. Galaxy-to-galaxy variation in $f_{\rm esc}^{\rm Lyα}$ is linked to compact, low-attenuation star-forming regions traced by UV continuum rather than global dust or stellar structure.
...
TL;DR: The paper introduces Milky Way Near Twins (MWNeTs), a framework that shifts the search for Milky Way analogues from similarity in present-day global properties to evolutionary similarity, using a five-stage hierarchical methodology and the concept of "evolutionary memory" to identify galaxies with broadly comparable formation and evolutionary pathways.


<details>
  <summary>Details</summary>
Motivation: Traditional searches for Milky Way analogues rely on limited present-day global properties (e.g., morphology), but galaxies with similar current properties may have very different assembly histories, secular evolution, nuclear activity, and environmental histories. The authors aim to reformulate the search toward evolutionary similarity rather than parameter-based similarity.

Method: A hierarchical five-stage methodology: (1) isolation and cosmic-web context, (2) morphological and structural constraints, (3) nuclear activity and supermassive black hole properties, (4) global spectrophotometric and dynamical constraints, and (5) advanced evolutionary diagnostics. Stages 1–4 identify galaxies matching the present-day MW state; Stage 5 tests evolutionary similarity using independent signatures (e.g., SED, rotation-curve morphology, chemo-dynamical signatures, globular-cluster systems, merger history, CGM properties, multiwavelength fossil tracers). The concept of "evolutionary memory" is introduced, where diagnostics probe physical processes on different timescales and layers of galaxy formation.

Result: The MWNeT framework establishes an observational bridge between Galactic and extragalactic astronomy, providing a systematic approach to identify galaxies that are not only similar to the MW in present-day properties but also share broadly comparable evolutionary pathways.

Conclusion: The MWNeT framework supports future searches for the closest evolutionary counterparts of the Milky Way by shifting the paradigm from static present-day similarity to dynamic evolutionary similarity.
...
TL;DR: This paper investigates multiple stellar populations along the asymptotic giant branch (AGB) in 22 globular clusters using APOGEE spectroscopy and Gaia data, finding that second-generation (2P) stars are underrepresented in the AGB of nine clusters (AGB-manqué phenomenon), measuring population fractions, radial distributions, and detecting iron inhomogeneities in AGB stars for the first time.


<details>
  <summary>Details</summary>
Motivation: To characterize multiple stellar populations in the AGB phase across a large sample of globular clusters, quantify the AGB-manqué phenomenon spectroscopically, and investigate radial distributions and chemical peculiarities of AGB stars, which are less studied than RGB stars.

Method: APOGEE spectroscopy combined with Gaia color-magnitude diagram-based AGB selection; analysis of light-element abundances ([C/Fe], [N/Fe], [Mg/Fe], [Al/Fe]) to disentangle first- (1P) and second-population (2P) stars; comparison of AGB and RGB population fractions; radial distribution analysis.

Result: 1P fraction decreases with cluster mass; nine GCs show chemically extreme 2P stars underrepresented on AGB (AGB-manqué); first spectroscopic characterization of AGB multiple populations in eight GCs; radial distributions of AGB 2P stars in four clusters with unexpected trends in NGC2808 and NGC7078; anomalous AGB populations in NGC6656 and Omega Centauri; first detection of iron inhomogeneities among 1P AGB stars in NGC5272.

Conclusion: The AGB-manqué phenomenon is widespread and can be identified via a quantitative spectroscopic criterion; AGB 2P radial distributions can differ from RGB in some clusters; iron variations extend to the most evolved stellar phase studied; heavy-element-enhanced anomalous populations show stronger AGB-manqué signatures, possibly due to enhanced He or increased RGB mass loss.
...
TL;DR: This study quantifies how low spatial resolution truncates the high-density power-law tails of column density PDFs (N-PDFs) in molecular clouds, proposes a parameter-free model to predict truncation, develops a reverse method to recover intrinsic tails, and links N-PDF shapes to cloud morphologies, providing a framework for correcting resolution biases in distant cloud observations.


<details>
  <summary>Details</summary>
Motivation: Observational resolution significantly biases the interpretation of N-PDFs in molecular clouds, which are critical for understanding turbulence and star formation. This study aims to quantify how low spatial resolution truncates high-density power-law tails and to develop methods for correcting these biases.

Method: Simulated distant observations (2-10 kpc) of 17 local massive molecular clouds using Herschel-based column density maps; a parameter-free model assuming proportional embedding of dense regions within lower-density gas to predict truncation column density where survival function equals beam-to-threshold area ratio; Delta-variance spectra to derive characteristic cloud scales.

Result: Good agreement between model and simulations, with deviations up to 0.3 dex due to cloud multiplicity and flattened power-law tails. Global smearing dominates when beam sizes exceed characteristic cloud scales. A reverse method recovers intrinsic high-density tails from low-resolution data.

Conclusion: N-PDF shapes are linked to cloud morphologies: feedback-compressed extended structures resist smearing while multiplicity accelerates truncation. The framework corrects resolution effects in distant cloud studies, enhancing constraints on star formation theories.
...
TL;DR: This study presents new low-frequency (≤1 GHz) hydrogen radio recombination line observations of three positions in the Galactic plane with few known HII regions, using the Green Bank Telescope. Combined with GDIGS 5.8 GHz data and forward modeling, the analysis finds electron densities of 6–15 cm⁻³ and shows that determining gas temperature and emission measure requires informative priors or higher S/N data.


<details>
  <summary>Details</summary>
Motivation: To characterize the properties of the dense warm ionized medium in the Milky Way using new low-frequency HRRL observations, motivated by advances in radio instrumentation and the availability of fully sampled HRRL maps and better knowledge of discrete HII region populations.

Method: Targeted three positions in the Galactic plane with few known HII regions using the 342 MHz and 800 MHz feeds of the Green Bank Telescope. Combined these low-frequency observations with fully sampled HRRL 5.8 GHz cubes from GDIGS and applied a forward modeling approach to derive gas properties.

Result: HRRL emission detected from all three positions. Electron densities determined to be between 6 and 15 cm⁻³. Gas temperature and emission measure determination require informative priors or higher signal-to-noise observations.

Conclusion: Low-frequency HRRL observations combined with higher-frequency data can constrain electron density of the warm ionized medium, but higher S/N or prior information is needed to reliably determine gas temperature and emission measure.
...
TL;DR: Using JWST/NIRCam imaging and time delays, the authors model the quadruply imaged quasar WFI2033-4723 with a composite stellar+dark-matter model. They recover Fermat-potential differences consistent with previous analyses, use external cosmological priors (Planck+DESI, Pantheon+SH0ES) to break degeneracies, find stellar normalization between Chabrier and Salpeter IMFs, and a dark-matter inner slope γ_in~1.3 steeper than NFW. Reversing the logic to infer cosmology is limited by H0-Rs degeneracy.


<details>
  <summary>Details</summary>
Motivation: To separate baryonic and dark-matter contributions in strong gravitational lens systems using time delays and high-resolution JWST data, testing whether composite modeling can effectively break the mass-sheet degeneracy without kinematic data.

Method: High-resolution JWST/NIRCam imaging + measured time delays; elliptical power-law baseline model; composite stellar (MGE with radial mass-to-light gradient) + dark-matter (gNFW) model; external cosmological priors (Planck+DESI, Pantheon+SH0ES) to constrain mass-sheet-transformation freedom.

Result: Stellar normalization lies between Chabrier and Salpeter IMF expectations; radial mass-to-light gradient mildly positive (not strongly required); dark-matter inner slope γ_in~1.3 (steeper than standard NFW cusp); main conclusions insensitive to cosmological prior; reverse inference of cosmology limited by strong H0-Rs degeneracy.

Conclusion: Composite time-delay lens modeling can effectively separate baryons from dark matter, but standalone cosmological inference from this system is prevented by the H0-Rs degeneracy.
...
TL;DR: This paper uses optical light curves from GAIA and Pan-STARRS to classify AGNs into blazars and non-blazars using a LightGBM model, achieving ~86% accuracy, with feature reduction from 70 to 13 features via BoostBoruta while maintaining performance.


<details>
  <summary>Details</summary>
Motivation: To classify AGNs into blazars and non-blazars using only optical light curves, without relying on multiwavelength information, which differs from most existing works.

Method: Optical light curves from GAIA and Pan-STARRS were processed using the FATS library and custom algorithms to extract time-series features. A LightGBM model was trained for classification, with feature selection via BoostBoruta and self-learning via pseudo-labeling for unknown candidates.

Result: LightGBM achieved 86% accuracy with precision, recall, and F1 score above 80-85%. BoostBoruta reduced features from 70 to 13 with comparable performance. Self-training classifier yielded 85% accuracy.

Conclusion: Optical variability alone is sufficient for reliable classification of blazars vs. non-blazar AGNs, and the model is robust with effective feature reduction and pseudo-labeling for unknown objects.
...
TL;DR: VAPOLA is the first online, multi-epoch, multi-band repository of high-level ALMA data products from VLBI observations of AGN and Sgr A*, providing ready-to-use calibrated visibilities, full-Stokes images, and polarimetric maps through an automated pipeline with a user-friendly web portal.


<details>
  <summary>Details</summary>
Motivation: Processing and analyzing ALMA data obtained in APS mode during VLBI observations remains complex, requiring specialized expertise and time-consuming calibration and imaging procedures, hindering access for non-expert users.

Method: Built an automated pipeline that processes fully calibrated ALMA (QA2) data to generate science-ready products with minimal user intervention; data served through a user-friendly web portal.

Result: Repository includes fully calibrated interferometric visibilities, full-Stokes images across individual and combined spectral windows, polarimetric and spectral index maps, and tabulated polarimetric parameters from visibility-domain polarization fitting.

Conclusion: VAPOLA enables non-expert users to perform advanced science analyses without deep ALMA expertise, facilitating investigations of magnetic fields in accretion flows and jets, AGN torus structure/kinematics, and interstellar medium absorption studies, while also providing metadata for refining VLBI calibration and theoretical modeling of SMBHs.
...
TL;DR: First interstellar detection of the three-ring PAH phenalene (C₁₃H₁₀) outside TMC-1 CP, in the dense core MC27/L1521F containing a VeLLO. Enhanced abundance relative to benzonitrile by a factor of four compared to TMC-1 CP, supporting widespread PAH distribution and possible survival/inheritance/replenishment during early star formation.


<details>
  <summary>Details</summary>
Motivation: To investigate the distribution and evolution of PAHs in cold interstellar environments beyond the well-studied TMC-1 CP core, and to understand their fate during the earliest stages of star formation.

Method: Interstellar detection of phenalene via radio astronomical observations toward MC27/L1521F; comparative abundance analysis with benzonitrile between MC27/L1521F and TMC-1 CP.

Result: Phenalene is detected in MC27/L1521F, with a phenalene-to-benzonitrile abundance ratio enhanced by a factor of four relative to TMC-1 CP.

Conclusion: PAHs are widespread in the cold ISM, and their abundances can vary between sources, consistent with survival, inheritance, or replenishment during early star formation stages.
...
TL;DR: Using ACT DR6 data, the authors confirm the Planck power-law relation between stellar mass and tSZ signal for LBGs, identify ~few% radio source contamination, and find a factor-of-two excess in the y-signal for LBGs with co-spatial radio sources, suggesting either halo mass differences or AGN feedback effects.


<details>
  <summary>Details</summary>
Motivation: To re-examine the Planck collaboration's finding of a power-law relation between stellar mass and tSZ signal using higher-resolution, lower-noise ACT DR6 data, and to investigate previously unaccounted contamination from radio sources.

Method: Analysis of ACT DR6 component-separated Compton-y maps over one-third of the sky; comparison of cylindrical Compton-y signal scaling with stellar mass; subselection of LBGs with and without co-spatial radio sources to assess contamination and excess signal.

Result: Consistent power-law scaling confirmed; residual radio source contamination at the few-percent level identified; a factor-of-two excess in y-signal for LBGs hosting co-spatial radio sources at fixed stellar mass is found, persisting to >6 arcmin and also recoverable in Planck data.

Conclusion: The excess may stem from systematic halo mass differences or AGN thermal energy injection into the CGM; careful radio source characterization is needed in future tSZ cross-correlation studies.
...
TL;DR: The paper develops a moment-based convergence framework for Lyman-alpha Monte Carlo radiative transfer momentum-transfer estimators in static spherical clouds, establishing diffusion-limit benchmarks and testing three estimators (event-based, gradient-of-energy-density, divergence-of-radiation-pressure) across three convergence orders—correct mean, finite-sampling uncertainty, and uncertainty stability—with applications to core-skipping, source geometry, estimator construction, and spatial resolution.


<details>
  <summary>Details</summary>
Motivation: Convergence of Monte Carlo radiative transfer (MCRT) for Lyman-alpha resonant-line transport is difficult to assess in optically thick media where photons undergo many scatterings. This is especially critical for internal quantities like radiative acceleration and force multiplier, which depend on momentum deposition throughout the gas rather than only emergent spectra.

Method: The authors establish diffusion-limit benchmarks for radial acceleration profiles and integrated force multipliers, then develop a moment-based framework diagnosing convergence from photon-packet contribution distributions. The framework separates three questions: (0) whether the estimator converges to the correct mean, (1) how large its finite-sampling uncertainty is, and (2) whether the estimated uncertainty is itself stable. Three estimators are tested: direct event-based scattering, gradient-of-energy-density, and divergence-of-radiation-pressure. Convergence is assessed via profile comparisons, integrated force-multiplier bias, finite-group relative error (zeroth-order); fractional error, photon number to target precision, runtime (first-order); coefficient of variation of variance (second-order).

Result: Core-skipping prescriptions, source geometry, estimator construction, and spatial resolution affect the convergence hierarchy differently. The framework reveals why statistical precision, computational cost, and physical accuracy must be evaluated separately for internal Lya MCRT force calculations.

Conclusion: The paper provides a practical convergence framework for internal Lya MCRT force calculations, demonstrating that statistical precision, computational cost, and physical accuracy require independent assessment, with the three-order hierarchy offering a systematic diagnostic for convergence reliability.
...
TL;DR: JWST Cycle 3 NIRSpec G395M and MIRI/LRS observations of Maisie's Galaxy at z=11.408 reveal it is a typical, rather than extreme, star-forming galaxy based on [OII] SFR, metallicity, and ionization parameter measurements, suggesting deeper observations are needed to understand the average galaxy population at z>10.


<details>
  <summary>Details</summary>
Motivation: JWST has found unexpectedly large numbers of bright z>10 galaxies, with spectroscopy implying extreme star formation or AGN activity. This paper aims to determine whether Maisie's Galaxy is truly extreme or representative of the typical early-Universe galaxy population.

Method: Combined two deep Cycle 3 NIRSpec G395M programs (>19 hours exposure) plus MIRI/LRS observations. Measured [OII] doublet for electron density and SFR, [OIII]λ5008 and [NeIII]λ3869 for Ne3O2 and O32 ratios, then inferred metallicity and ionization parameter.

Result: Redshift z=11.408±0.005; electron density n_e=108.56^+873.9_-35.37; SFR_[OII]=1.3±0.35 M☉/yr (on SFMS); log(Ne3O2)=-0.219±0.145; log(O32)=0.724±0.191; metallicity Z/Z☉=0.17±0.05; log(U)=-2.26±0.13.

Conclusion: Maisie's Galaxy is a typical, not extreme, star-forming galaxy at z>10, along the star-formation main sequence. Deeper observations are needed to characterize the average galaxy population at these early epochs.
