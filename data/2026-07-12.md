...
TL;DR: Using XRISM observations of M82's hot wind, the authors find that a supernova-driven free-wind model cannot replicate the observed velocity dispersion, requiring additional broadening from non-thermal motions (Mach 1.71-3.14) in the starburst core, suggesting energy is diverted to magnetic fields and cosmic rays rather than heating the gas.


<details>
  <summary>Details</summary>
Motivation: To understand the driving mechanism of M82's multiphase outflow by testing supernova-driven wind models against new XRISM constraints on hot wind temperature and velocity dispersion.

Method: The authors generate idealized hydrodynamic simulations with varying energy and mass loading, construct mock X-ray spectra, and compare them directly to XRISM observations of M82's hot wind.

Result: The free-wind model cannot reproduce the observed velocity dispersion; extra broadening from non-thermal motions (Mach 1.71-3.14) is required, implying supersonic hot gas motions in the galactic center.

Conclusion: Supersonic non-thermal motions in the starburst core indicate that supernova energy is partially diverted from gas heating to other processes (magnetic field amplification, cosmic ray acceleration), challenging standard wind-driving models.
...
TL;DR: This paper quantifies radial mixing in exoplanet hosts by cross-matching exoplanet catalogs with Gaia DR3 data, finding that giant-planet hosts originate from inner-Galaxy birth sites, brown-dwarf hosts show broader radial displacements, and rocky-only systems have smaller excursions. Outward-migrators host more compact outer companions, and older rocky/rocky+giant hosts are useful for future habitability searches.


<details>
  <summary>Details</summary>
Motivation: To understand how radial mixing and birth environments of stars influence exoplanet architectures, orbital evolution, and Galactic habitability.

Method: Cross-matched Encyclopaedia of Exoplanetary Systems with Gaia DR3 astrometry, 2MASS, and AllWISE photometry; used Galpy for stellar orbit integration; inferred birth radii via Galactic chemical enrichment models combined with a generalized additive model from a prior study.

Result: Giant-planet hosts preferentially trace inner-Galaxy birth sites; brown-dwarf hosts span broader radial displacements; rocky-only systems show smaller radial excursions; outward-migrators host more compact outer companions; older ages found for rocky and rocky+giant hosts, especially outward migrators.

Conclusion: Giant-planet hosts retain strong connection to metal-rich inner-Galaxy birth environments; dynamically heated outer-Galaxy-born hosts survive significant Galactic perturbations; no clear connection between radial displacement and detected planet multiplicity; rocky/rocky+giant hosts (particularly outward migrators) are useful for future habitability and technosignature searches.
...
TL;DR: Using ASTRID and TNG300 simulations, this paper tracks massive black holes from z=2 to z=0.5 and shows that the M_BH-M_star plane encodes the dynamical, accretion, and feedback history of BHs—including central, satellite, and wandering populations—with distinct evolutionary channels (mergers, tidal stripping, satellite accretion) producing characteristic offsets from the redshift-invariant main relation.


<details>
  <summary>Details</summary>
Motivation: To understand how the distribution of systems in the M_BH-M_star plane encodes integrated BH-galaxy growth and the processes shaping their evolution, by following BHs themselves (not just their hosts) across cosmic time.

Method: Analyzed massive BHs from z=2 to z=0.5 (5.3 Gyr) in the ASTRID and TNG300 cosmological simulations, tracking central BHs, BHs in satellites, and off-nuclear wandering BHs individually across time.

Result: Central BHs follow a tight, nearly redshift-invariant M_BH-M_star relation consistent with local constraints and AGN variability measurements. High-mass central BHs grow via mergers and quench hosts via AGN kinetic feedback. Tidal stripping produces overmassive central BHs in gas-poor satellites. Wandering BHs in ASTRID are undermassive with minimal accretion/merger growth.

Conclusion: A BH's location in the M_BH-M_star and sBHAR-sSFR planes serves as a fossil record of its dynamical, accretion, and feedback history, with characteristic regions traced by distinct evolutionary channels.
...
TL;DR: This paper uses eROSITA X-ray data and Legacy Survey optical data to construct the largest catalogue of X-ray AGN in low-redshift galaxies, including ~874 low-mass galaxies. Using Bayesian modeling, the authors constrain the specific accretion rate distribution down to the low-mass regime (logM*/Msol<10), find a break at high λ_SAR indicative of Eddington-limited growth, and report a cumulative AGN fraction of ~1% for low-mass galaxies above λ_SAR>10^-3, placing a firm lower limit on black hole occupation fraction.


<details>
  <summary>Details</summary>
Motivation: To probe the distribution of specific accretion rates and AGN fraction in low-redshift galaxies, particularly low-mass galaxies (logM*/Msol<10), which may serve as local analogues of the first galaxies in the early Universe. The study aims to uncover mass-dependent effects in AGN growth and accretion history that have been unexplored in the low-mass regime.

Method: Cross-matching four-pass eROSITA All Sky Survey X-ray data with ~5.35 million galaxies from Legacy Survey DR10 (z-band <20 mag, 0.03<z<0.2). Rigorous cleaning and validation of X-ray aperture photometry and host-galaxy associations. A Bayesian framework constrains the specific accretion rate distribution p(logλ_SAR | M*, z) across a wide range, using X-ray information from all parent sample galaxies.

Result: Identified 874 X-ray AGN in low-mass galaxies (most newly discovered). Detected a break at high λ_SAR, possibly indicating Eddington-limited, self-regulated black hole growth. Found a cumulative AGN fraction of ~1% for low-mass galaxies above λ_SAR>10^-3, placing a firm lower limit on the black hole occupation fraction in this regime.

Conclusion: The specific accretion rate distributions highlight a nuanced, mass-dependent view of AGN growth and accretion history that must be incorporated into future modeling. The low-mass regime has been explored down to previously unexplored levels.
...
TL;DR: The ultra-faint dwarf galaxy Boötes III has a much smaller velocity dispersion (1.69 km/s) than previously reported (10.7 km/s), making it consistent with other tidally disrupting dwarfs. It follows a highly eccentric polar orbit and is likely actively losing its dark matter to tides, testing cored vs. cuspy dark matter profiles. Its tidal streams may be linked to the Styx stream, while the Typhon stream is chemically distinct but possibly co-infalling.


<details>
  <summary>Details</summary>
Motivation: To refine the systemic properties of the ultra-faint dwarf galaxy Boötes III using high-quality spectroscopic data from S$^5$, given that previous measurements gave anomalously high velocity dispersion, and to assess its tidal disruption status and dark matter content.

Method: Identification of 21 high-probability members from S$^5$ spectroscopy; measurement of velocity dispersion and mean metallicity; orbit integration in a MW + LMC potential; comparison of tidal radius to half-light radius; simulation of tidal streams.

Result: Velocity dispersion = 1.69^{+1.03}_{-0.85} km/s (six times smaller than previous 10.7 km/s); mean [Fe/H] = -2.34 ± 0.11; highly eccentric (e~0.8), polar orbit with recent pericenter ~0.14 Gyr ago at ~9.5 kpc; tidal radius at pericenter (164 pc) is ~0.35 of half-light radius; Boötes III likely tidally disrupting and dark-matter-depleted or cored.

Conclusion: Boötes III is a tidally disrupting ultra-faint dwarf with a low velocity dispersion, consistent with other disrupting dwarfs. Its properties make it a probe of dark matter (cored vs. cuspy). The Styx stream is a plausible tidal tail but sensitive to MW/LMC mass assumptions. Typhon stream is chemically distinct but may share infall origin. Deep spectroscopy is needed to confirm the stream association.
...
TL;DR: Using high-resolution N-body simulations of MBHBs from IllustrisTNG, this study finds highly eccentric binaries, short coalescence times (~1.0 Gyr for black holes, ~0.7 Gyr for galaxies), and derives scaling relations linking galaxy properties to binary evolution stages, consistent with PTA observations of a nanohertz gravitational wave background.


<details>
  <summary>Details</summary>
Motivation: PTA observations suggest a gravitational wave background amplitude higher than standard model predictions, necessitating a robust understanding of MBHB merger timescales and their connection to host galaxy properties to correctly interpret these signals.

Method: MBHBs are selected from cosmological galaxy mergers in IllustrisTNG, re-simulated at high resolution with the N-body code Griffin to resolve dynamical friction and stellar hardening, then evolved to coalescence via a semi-analytical model.

Result: Cosmological MBHBs are typically highly eccentric; galaxy mergers complete within ~0.7 Gyr and total black hole coalescence within ~1.0 Gyr. Scaling relations linking galaxy/orbital properties to coalescence times are derived.

Conclusion: Short merger timescales imply efficient binary evolution consistent with current PTA constraints, and the derived scaling relations provide a framework for subgrid prescriptions in cosmological simulations.
...
TL;DR: Using DESI DR1 spectroscopy, we probabilistically classified 251,413 radio sources from LoTSS DR2 into SFGs, RQ AGN, LERGs, and HERGs. At 90% confidence, we identified 139,403 sources (the largest such radio sample to date), showing LERGs accrete below 1% Eddington and HERGs above it, with a subset of high-accreting LERGs showing star-forming features.


<details>
  <summary>Details</summary>
Motivation: To disentangle the faint radio-source population, which includes both star formation and AGN contributions, in order to better understand the roles these two processes play in galaxy evolution.

Method: Probabilistic classification of 251,413 LoTSS DR2 sources using DESI DR1 spectroscopy, combining: (i) radio excess relative to SF, (ii) BPT diagram, (iii) modified Mass Excitation diagram, and (iv) [OIII]5007 equivalent width, integrated with Monte Carlo methods to assign probabilities for SFG, RQ AGN, LERG, and HERG classes.

Result: At >90% probability threshold: 68,820 SFGs, 32,288 RQ AGN, 35,210 LERGs, 3,085 HERGs. LERGs accrete below 1% Eddington limit, HERGs above it. A small subset of high-accreting LERGs show prominent star-forming features in stacked spectra.

Conclusion: Demonstrated the power of large spectroscopic samples for characterizing the radio-source population, providing a robust foundation for future studies in the SKA era.
...
TL;DR: This study shows that current emission line diagnostics (like HeII) can detect galaxies purely composed of Pop III stars, but fail for realistic hybrid Pop III/Pop II systems due to degeneracies, highlighting the need for new methods that account for mixed stellar populations.


<details>
  <summary>Details</summary>
Motivation: Identifying Population III stars is a central challenge in astrophysics, and hybrid Pop III/Pop II stellar populations complicate the interpretation of observed spectra.

Method: Galaxies with varying Pop III-to-total mass ratios are selected from IllustrisTNG cosmological simulations; self-consistent photoionisation models compute integrated spectra using local physical conditions from the simulations to study emission line diagnostics.

Result: Emission line diagnostics strongly depend on the relative Pop III contribution; current diagnostics can identify Pop III-dominated galaxies but fail for systems with significant Pop II contribution due to degeneracies.

Conclusion: Existing emission line diagnostics are limited in hybrid systems, emphasizing the need for additional methods that account for mixed stellar populations to reliably detect Pop III stars during and after the epoch of reionization.
...
TL;DR: The LSTM-MDNz architecture integrates LSTM feature extraction with Mixture Density Networks to improve photometric redshift estimation and uncertainty quantification, achieving ~10% better point-estimation accuracy and ~20% fewer outliers compared to BNN baselines on the HSC GalaxiesML dataset, with well-calibrated PDFs enabling high-purity catalog construction.


<details>
  <summary>Details</summary>
Motivation: Accurate photo-z estimation and robust uncertainty quantification are critical for LSST precision cosmology, but traditional ML methods produce only point estimates and fail to capture multimodal redshift PDFs and color-redshift degeneracies.

Method: LSTM-MDNz treats multi-band photometry as wavelength-ordered sequences, using LSTM networks to capture non-linear SED correlations, then applies a Mixture Density Network (MDN) to model posterior PDFs via Gaussian mixture models (GMMs).

Result: Outperforms BNN baseline with ~10% improvement in point-estimation accuracy (RMSE, MAE, scatter, σ_NMAD) and ~20% reduction in outlier rates; uniform PIT distribution confirms calibration; excluding ~4% low-confidence (z_conf<0.05) samples reduces outlier rate by ~48%.

Conclusion: LSTM-MDNz provides accurate, well-calibrated photo-z PDFs suitable for next-generation cosmological surveys, with effective confidence-based filtering for high-purity catalog construction.
...
TL;DR: Disagreements among electron density diagnostics in ionized nebulae are not due to atomic data flaws or ionization stratification, but because each diagnostic is sensitive to a different part of the broad density distribution present in real nebulae, meaning there is no single representative electron density.


<details>
  <summary>Details</summary>
Motivation: A long-standing puzzle exists where different density-sensitive emission lines applied to the same ionized gas return electron density values that disagree by up to two orders of magnitude, previously attributed to distinct ionization zones or imperfect atomic data.

Method: The authors demonstrate that each density diagnostic is tuned to a particular density; in real nebulae with a wide range of densities, each line reports the part of that range it is most sensitive to, rather than a representative average. A simple relation between the returned density and the diagnostic's sensitivity peak resolves the discrepancy.

Result: The relation holds from individual H II regions to entire galaxies, both nearby and distant, and reveals that ionized nebulae contain far more dense gas than any single diagnostic implies.

Conclusion: Ionized nebulae possess a broad density distribution rather than a single electron density. Measurements of masses, pressures, abundances, and energetics built on the single-density assumption must be reconsidered across all scales.
...
TL;DR: CARPP is a publicly available fitting package that generates optimized density and temperature profiles of dense molecular cores from multi-wavelength dust continuum data, achieving high accuracy and classifying core dynamical states (e.g., hydrostatic equilibrium vs. collapsing envelope).


<details>
  <summary>Details</summary>
Motivation: Density profiles of dense molecular cores are key indicators of their physical and evolutionary states, and multi-wavelength dust continuum data can provide strong constraints, but a practical, standardized tool for efficient yet physically faithful inference was lacking.

Method: CARPP assumes spherical symmetry, adopts physically motivated parametric forms for density and temperature profiles, and performs parameterized radiative transfer calculations fitted to dust continuum data.

Result: On synthetic data, CARPP achieves average relative errors <20% for its seven parameters when data quality meets a derived criterion. On real data, it classifies TMC-1C as a Bonnor-Ebert sphere (near-hydrostatic equilibrium) and Ori2-2 as a power-law-dominated collapsing envelope.

Conclusion: CARPP is a powerful, versatile tool for classifying the dynamical states of individual cores, offering an optimal balance between physical fidelity and computational efficiency as a standardized alternative to both simple SED analyses and expensive 3D radiative-transfer modeling.
...
TL;DR: This paper directly measures the Lyα escape fraction at z≈6.2 using JWST/NIRCam F470N and Subaru/HSC NB872 narrowband imaging, finding a median f_esc^{Lyα} of 0.106, and explores its correlations with galaxy properties to understand ionizing photon escape during reionization.


<details>
  <summary>Details</summary>
Motivation: To directly measure the Lyα escape fraction during the epoch of reionization and understand which galaxy populations contribute to the ionizing photon budget, as Lyα escape may trace Lyman continuum leakage.

Method: Selected 84 Hα emitters (HAEs) at z≈6.2 using JWST/NIRCam F470N excess; obtained simultaneous Lyα and Hα fluxes using Subaru/HSC NB872 imaging; performed completeness-weighted stacking and individual galaxy correlation analyses.

Result: Median f_esc^{Lyα}=0.106^{+0.066}_{-0.044}; no significant dependence on Hα luminosity; f_esc^{Lyα} positively correlates with Lyα EW, negatively with UV slope β and UV size; no significant correlation with E(B-V) or optical size.

Conclusion: Relatively luminous HAEs may importantly contribute to ionizing photon budget during EoR; galaxy-to-galaxy variation in Lyα escape is linked to compact, low-attenuation star-forming regions rather than global dust or stellar structure.
...
TL;DR: The paper introduces Milky Way Near Twins (MWNeTs), a framework to find galaxies that resemble not only the present-day properties of the Milky Way but also its evolutionary history, using a five-stage hierarchical methodology and the concept of "evolutionary memory" to assess similarity across multiple timescales and physical processes.


<details>
  <summary>Details</summary>
Motivation: Traditional searches for Milky Way analogues rely on limited present-day global properties (e.g., morphology), which can miss galaxies with similar current properties but vastly different formation histories. The authors argue for a shift toward evolutionary similarity to find truly comparable extragalactic counterparts of the MW.

Method: A five-stage hierarchical methodology: (1) isolation and cosmic-web context, (2) morphological and structural constraints, (3) nuclear activity and SMBH properties, (4) global spectrophotometric and dynamical constraints, and (5) advanced evolutionary diagnostics. Stages 1–4 filter by present-day similarity; Stage 5 tests evolutionary similarity using independent signatures (e.g., SED, rotation curves, chemo-dynamical signatures, globular clusters, merger history, CGM properties, fossil tracers).

Result: The MWNeT framework provides a systematic approach to identify galaxies with both present-day and evolutionary resemblance to the MW, leveraging multiwavelength diagnostics that probe different timescales ("evolutionary memory").

Conclusion: The MWNeT framework establishes an observational bridge between Galactic and extragalactic astronomy, supporting future searches for the closest evolutionary counterparts of the Milky Way.
...
TL;DR: This paper investigates multiple stellar populations along the asymptotic giant branch (AGB) in 22 globular clusters using APOGEE spectroscopy and Gaia data, finding that second-population (2P) stars are underrepresented in AGB (AGB-manqué phenomenon) in nine clusters, with the 1P fraction decreasing with cluster mass, and reports the first spectroscopic characterization of AGB multiple populations in eight GCs, radial distributions in four clusters, anomalous populations in NGC6656 and ωCen, and iron inhomogeneities among 1P AGB stars in NGC5272.


<details>
  <summary>Details</summary>
Motivation: To systematically investigate multiple stellar populations along the AGB across a large sample of globular clusters, characterize the AGB-manqué phenomenon spectroscopically, and extend studies of chemical inhomogeneities to the most evolved stellar phase.

Method: APOGEE spectroscopy combined with Gaia color-magnitude diagram-based AGB selection; light-element abundances ([C/Fe], [N/Fe], [Mg/Fe], [Al/Fe]) to disentangle 1P and 2P; comparison of AGB and RGB populations; radial distribution analysis.

Result: 1P fraction decreases with cluster mass; nine GCs show AGB-manqué where most chemically extreme 2P stars fail to ascend the AGB; first spectroscopic characterization of AGB multiple populations in eight GCs; radial distributions in four clusters show NGC2808 and NGC7078 have unexpected increase of 2P fraction at large radii; anomalous populations in NGC6656 and ωCen show more pronounced AGB-manqué signature; iron inhomogeneities detected among 1P AGB stars in NGC5272.

Conclusion: The AGB-manqué phenomenon is common and linked to enhanced He and/or increased RGB mass loss; iron variations extend to the most evolved stellar phase; radial mixing may differ between AGB and RGB in some clusters.
...
TL;DR: This study quantifies how low spatial resolution truncates the high-density power-law tails of column density PDFs, proposes a parameter-free model to predict truncation, and develops a reverse method to recover intrinsic high-density tails from low-resolution data, using simulated distant observations of 17 local molecular clouds.


<details>
  <summary>Details</summary>
Motivation: Observational resolution significantly impacts the interpretation of N-PDFs in molecular clouds, which are essential for understanding turbulent structures and star formation processes.

Method: Simulated distant observations (2-10 kpc) of 17 local massive molecular clouds/regions using Herschel-based column density maps; a parameter-free model assuming proportional embedding of dense regions within lower-density gas; Delta-variance spectra to derive characteristic cloud scales.

Result: Good agreement with simulations (deviations up to 0.3 dex); cloud multiplicity in large complexes and flatter power-law tails in coherent structures cause deviations; global smearing dominates when beam sizes exceed characteristic cloud scales.

Conclusion: Feedback-compressed extended structures resist smearing while multiplicity accelerates truncation; the framework corrects resolution effects in distant cloud studies, enhancing constraints on star formation theories.
...
TL;DR: New low-frequency observations of hydrogen radio recombination lines at three positions in the Galactic plane reveal dense warm ionized gas with electron densities of 6-15 cm$^{-3}$, requiring informative priors or higher SNR to constrain temperature and emission measure.


<details>
  <summary>Details</summary>
Motivation: Advances in radio instrumentation and the availability of fully sampled HRRL maps motivated new low-frequency observations to characterize the properties of the Milky Way's ionized gas, particularly in regions with few known HII regions.

Method: Observations at 342 MHz and 800 MHz using the Green Bank Telescope targeting three positions in the Galactic plane with few known HII regions, combined with GDIGS 5.8 GHz cubes, analyzed via forward modeling.

Result: HRRL emission detected at all three positions; electron densities of 6-15 cm$^{-3}$ derived; temperature and emission measure require informative priors or higher signal-to-noise data.

Conclusion: The warm ionized medium in the targeted regions has electron densities of 6-15 cm$^{-3}$, and constraining temperature/emission measure requires improved observations or prior information.
...
TL;DR: Using JWST/NIRCam imaging and time delays, the authors model the quadruply imaged quasar WFI2033–4723 with a composite stellar (multi-Gaussian expansion with radial mass-to-light gradient) plus dark-matter (gNFW halo) model. They recover Fermat-potential differences consistent with previous analyses, find stellar normalization between Chabrier and Salpeter IMFs, a mildly positive radial mass-to-light gradient, and a steep inner dark-matter slope (~1.3). The model effectively separates baryons from dark matter, but standalone cosmological constraints are limited by the H0–Rs degeneracy.


<details>
  <summary>Details</summary>
Motivation: To achieve a physically motivated separation of baryonic and dark-matter mass distributions in a strongly lensed quasar system, leveraging high-resolution JWST data and measured time delays to break degeneracies such as the mass-sheet transformation.

Method: The authors construct an elliptical power-law baseline model for reference, then replace it with a composite model: stellar mass via a multi-Gaussian expansion (MGE) of the lens light with a free radial mass-to-light gradient, and dark matter via a gNFW halo. They use time delays with two external cosmological priors (Planck+DESI and Pantheon+SH0ES) to constrain the model and break the mass-sheet degeneracy. They also test standalone cosmology inference.

Result: The stellar normalization lies between Chabrier and Salpeter IMF expectations; the radial mass-to-light gradient is mildly positive but not strongly required. The dark-matter inner slope is ~1.3, steeper than NFW. Results are insensitive to the cosmological prior. Standalone H0 inference is hampered by strong H0–Rs degeneracy.

Conclusion: Composite time-delay lens modeling can effectively separate baryons from dark matter without kinematic data. However, robust standalone cosmological constraints require additional information to break the H0–Rs degeneracy.
...
TL;DR: This paper uses optical light curves from GAIA and Pan-STARRS to classify AGNs into blazars and non-blazars via a LightGBM model, achieving ~86% accuracy with only 13 selected features, and demonstrates robustness through self-learning experiments.


<details>
  <summary>Details</summary>
Motivation: To classify AGNs into blazars and non-blazars using exclusively optical light curves, without relying on multiwavelength information—a strategy that differs from most existing approaches.

Method: Optical light curves from GAIA and Pan-STARRS were processed using the FATS library for standard time-series features, supplemented by custom algorithms. A LightGBM model was trained for binary classification, followed by feature selection via BoostBoruta (reducing 70 to 13 features) and a self-learning experiment with unknown AGN candidates.

Result: LightGBM achieved 86% accuracy with precision, recall, and F1 score above 80-85%. BoostBoruta reduced features to 13 with comparable performance. Self-training classifier yielded 85% accuracy, confirming robustness.

Conclusion: Optical variability alone is sufficient for reliable blazar/non-blazar classification, and the model's robustness is validated through self-learning with pseudo-labeling for unknown objects.
...
TL;DR: VAPOLA is the first online, multi-epoch, multi-band repository delivering high-level, science-ready ALMA data products (visibilities, full-Stokes images, polarimetric maps) from AGN and Sgr A* VLBI observations, enabling non-expert users to perform advanced analyses without specialized ALMA expertise.


<details>
  <summary>Details</summary>
Motivation: Processing ALMA data obtained in APS mode during VLBI observations is complex, time-consuming, and requires specialized expertise, creating a barrier for non-expert users to perform advanced science analyses.

Method: An automated pipeline processes fully calibrated ALMA (QA2) data with minimal user intervention to generate science-ready products, hosted on a user-friendly web portal.

Result: The repository includes fully calibrated interferometric visibilities, full-Stokes images (individual and combined spectral windows), polarimetric and spectral index maps, and tabulated polarimetric parameters from visibility-domain polarization fitting.

Conclusion: VAPOLA enables a broad range of scientific investigations (magnetic field properties in accretion flows/relativistic jets, AGN torus structure/kinematics, ISM absorption studies) and provides calibration metadata essential for refining VLBI workflows and constraining theoretical models of supermassive black holes.
...
TL;DR: This paper reports the first interstellar detection of phenalene (C₁₃H₁₀) outside TMC-1 CP, in the dense core MC27/L1521F, and compares its abundance to benzonitrile, finding a four-fold enhancement. The results support PAH widespread abundance in the cold ISM and suggest survival, inheritance, or replenishment during early star formation.


<details>
  <summary>Details</summary>
Motivation: To investigate the distribution and evolution of PAHs in the cold interstellar medium during star formation, following the detection of 14 PAHs in TMC-1 CP.

Method: Interstellar detection of phenalene via astronomical observations in the dense core MC27/L1521F, and abundance comparison with benzonitrile relative to TMC-1 CP.

Result: First detection of phenalene outside TMC-1 CP; phenalene abundance relative to benzonitrile is enhanced by a factor of four in MC27/L1521F.

Conclusion: PAHs are widespread in the cold ISM and may survive, be inherited, or be replenished during the earliest stages of star formation.
...
TL;DR: Using ACT DR6 maps, the authors confirm the Planck power-law relation between stellar mass and tSZ signal for LBGs, identify ~few% radio source contamination, and find a factor-of-two y-signal excess in LBGs with co-spatial radio sources (persisting to ≥6′), attributed to either halo mass differences or AGN feedback.


<details>
  <summary>Details</summary>
Motivation: To re-examine the Planck collaboration's stellar mass–tSZ power-law relation using higher-resolution, lower-noise ACT DR6 data, and to investigate previously unaccounted radio source contamination and its impact on the measured signal.

Method: Cross-correlation of ACT DR6 component-separated Compton-y maps with the Planck LBG sample over one-third of the sky; comparison of y-signal for LBGs with and without co-spatial radio sources; subselection analysis applied to original Planck data for consistency check.

Result: Consistent power-law scaling confirmed; residual radio source contamination at few-percent level identified; factor-of-two excess in Compton-y for LBGs hosting co-spatial radio sources at fixed stellar mass, persisting to ≥6′; same excess recovered in Planck data.

Conclusion: The radio source excess is robust and likely due to either systematic halo mass differences or AGN-driven thermal energy injection into the CGM; future tSZ cross-correlation analyses must carefully characterize radio source fractions in galaxy samples.
...
TL;DR: The paper develops a convergence diagnostic framework for Monte Carlo radiative transfer (MCRT) of Lyman-alpha photons in optically thick media, focusing on internal momentum-transfer estimators (radial acceleration, force multiplier). It benchmarks diffusion-limit solutions, proposes a three-level hierarchy (zeroth: mean accuracy; first: sampling uncertainty; second: variance stability), and evaluates three estimators (event-based scattering, gradient-of-energy-density, divergence-of-radiation-pressure) on convergence, bias, photon-cost, and reliability.


<details>
  <summary>Details</summary>
Motivation: Convergence of Lya MCRT is difficult to assess in optically thick media where photons scatter many times before escape, especially for internal quantities (e.g., radiative acceleration, force multiplier) that depend on momentum deposition throughout the gas, not just emergent spectra.

Method: The study uses static spherical clouds with diffusion-limit benchmarks, develops a moment-based convergence framework with three levels (zeroth-order: correct mean; first-order: finite-sampling uncertainty; second-order: variance stability), and applies it to three estimators: direct event-based scattering, gradient-of-energy-density, and divergence-of-radiation-pressure.

Result: Zeroth-order convergence assessed via profile comparisons, integrated force-multiplier bias, and finite-group relative error. First-order convergence quantified by fractional error, required photon number for target precision, and runtime. Second-order convergence tested by coefficient of variation of variance. Core-skipping, source geometry, estimator construction, and spatial resolution affect the hierarchy differently.

Conclusion: The framework provides a practical way to evaluate convergence of internal Lya MCRT force calculations, demonstrating that statistical precision, computational cost, and physical accuracy must be assessed separately.
...
TL;DR: JWST Cycle 3 NIRSpec G395M and MIRI/LRS observations of Maisie's Galaxy at z=11.408 reveal it is a typical star-forming (SFR=1.3 M⊙/yr) galaxy on the SFMS, not extreme, with metallicity Z/Z⊙=0.17 and log(U)=-2.26, suggesting deeper observations are needed to understand the average z>10 galaxy population.


<details>
  <summary>Details</summary>
Motivation: JWST has discovered unexpectedly large numbers of bright z>10 galaxies, with spectroscopy implying extreme star formation or AGN activity. The authors aim to determine whether these sources are genuinely extreme or representative of the typical early galaxy population.

Method: Combined two deep Cycle 3 NIRSpec G395M programs (>19 hours) plus MIRI/LRS for Maisie's Galaxy. Measured [OII] doublet for electron density and SFR, [OIII]λ5008 and [NeIII]λ3869 for Ne3O2 and O32 ratios, using these to derive metallicity and ionization parameter.

Result: Redshift z=11.408±0.005. Electron density n_e=108.56^{+873.9}_{-35.37}. SFR([OII])=1.3±0.35 M⊙/yr, placing it on the SFMS. log(Ne3O2)=-0.219±0.145, log(O32)=0.724±0.191. Metallicity Z/Z⊙=0.17±0.05, ionization parameter log(U)=-2.26±0.13.

Conclusion: Maisie's Galaxy is a typical, not extreme, star-forming galaxy at z>10. Deeper observations are needed to understand the average galaxy population at these early epochs.
...
### [24] [Multi-Wavelength Signatures of a Giant Cometary Radio Halo in MACSJ0417-1154](https://arxiv.org/abs/2607.07750)
*Ramananda Santra,Marco Balboni,Ruta Kale*

Main category: astro-ph.HE

TL;DR: Multi-frequency study of radio halo and relics in MACSJ0417 (z=0.445) using uGMRT, MeerKAT, and XMM-Newton. Halo extends ~1.75 Mpc, relics at 2.9 Mpc. Spectral indices α~-1.3 (halo) and α~-1.6 (relics). Strong radio-X-ray correlation (~0.85) supports turbulent re-acceleration; pure hadronic model excluded. Propose a minor off-axis dissociative merger (mass ratio ~6:1) powering the giant radio halo while preserving the cool core.


<details>
  <summary>Details</summary>
Motivation: To understand plasma processes in the intracluster medium (ICM) by studying diffuse non-thermal radio emission in galaxy clusters, providing the first multi-frequency analysis of the radio halo in MACSJ0417.

Method: Multi-frequency radio observations using uGMRT (300-850 MHz) and MeerKAT (900-1670 MHz) combined with archival XMM-Newton X-ray data. Performed spectral index mapping, surface brightness correlation analysis, and morphological comparisons between radio and X-ray emission.

Result: Halo extends to ~1.75 Mpc at 400 MHz; two candidate relics detected at 2.9 Mpc. Integrated spectra are single power-laws (α~-1.3 halo, α~-1.6 relics). A radio surface brightness edge coincides with an X-ray discontinuity. Spectral index shows radial steepening and fluctuations. Strong radio-X-ray correlation (~0.85) with slope evolving from sublinear to linear with frequency. High-temperature regions (~11 keV) along SE-NW axis.

Conclusion: Results support the turbulent re-acceleration model and exclude the pure hadronic model due to unrealistic cosmic-ray proton energy requirements. The cluster is undergoing a minor off-axis dissociative merger (mass ratio ~6:1) along SE-NW, preserving its cool core while driving turbulence that powers the giant radio halo.
...
### [25] [Sub-Torque-Balance Upper Limits on Continuous Gravitational Waves from Scorpius X-1](https://arxiv.org/abs/2607.07765)
...
TL;DR: LIGO's fourth observing run searched for continuous gravitational waves from Scorpius X-1 using a cross-correlation pipeline, setting upper limits below the torque balance level for frequencies 50-200 Hz, with the most sensitive limit approaching h0 ~ 5×10⁻²⁶, ruling out torque balance for a hadronic equation of state neutron star in this spin range.


<details>
  <summary>Details</summary>
Motivation: To detect continuous gravitational waves from the low-mass X-ray binary Scorpius X-1, a promising source for such signals, using improved LIGO data from the fourth observing run.

Method: Applied the resampling version of the cross-correlation pipeline to LIGO data from O4's first part, searching for signal frequencies 25-200 Hz (covering both triaxial and r-mode GW emission), followed by hierarchical followup and analysis of additional data to rule out outliers.

Result: Set upper limits below the standard torque balance level (independent of spin inclination) for 50-200 Hz; most sensitive upper limits approach 5×10⁻²⁶ (marginalized over inclination) and 2×10⁻²⁶ (favorable inclination); sensitivity depth 70-75 Hz⁻¹/²; ellipticity constraints of 3×10⁻⁵ at 75 Hz and 3×10⁻⁶ at 200 Hz.

Conclusion: Results argue against torque balance in the 50-200 Hz spin range for a hadronic equation of state neutron star, though uncertainties in torque modeling and equation of state limit inference strength. Outliers were ruled out as potential signals.
...
### [26] [The SANE, the MAD, and the Chimera](https://arxiv.org/abs/2607.07784)
*George N. Wong,James M. Stone*

Main category: astro-ph.HE

TL;DR: Three 3D GRMHD simulations (SANE, MAD, Chimera) are compared. The Chimera achieves MAD-level horizon flux and jet power without the bursty variability and morphology of standard MADs, showing that accretion history and flux supply can decouple MAD-like diagnostics.


<details>
  <summary>Details</summary>
Motivation: To understand whether MAD-like behavior (strong magnetic flux, powerful jets) is uniquely associated with a specific dynamical state or can arise from different accretion histories and magnetic flux supplies.

Method: Comparison of three 3D general relativistic magnetohydrodynamics (GRMHD) simulations: a weakly magnetized SANE flow, a standard MAD, and a Chimera flow with a different reservoir of mass, angular momentum, and coherent magnetic flux.

Result: The Chimera reaches MAD-level horizon magnetic flux and launches a powerful electromagnetic jet without the bursty horizon-flux variability, mass-flow distribution, or inner-flow morphology typical of standard MADs. SANE radial support is primarily hydrodynamic (gas pressure gradients), while MAD flows involve magnetic pressure and tension at comparable order. The Chimera remains distinct in density structure, funnel-wall geometry, mass-flow channels, radial force budget, and angular-momentum transport.

Conclusion: MAD-like behavior is not captured by any single diagnostic but by a dynamical coupling of multiple outcomes (horizon flux, jet power, magnetic support, Maxwell transport, surface-layer flow, disk morphology, eruption activity). These outcomes can be separated by accretion history and magnetic-flux supply, as demonstrated by the Chimera.
...
### [27] [Compact Objects Merging with Stars as an Origin of Ultra-Long Gamma-Ray Bursts and Luminous Fast Blue Optical Transients](https://arxiv.org/abs/2607.07819)
*V. Ashley Villar,Anya E. Nugent,Eric Burns,Brian D. Metzger,Tarraneh Eftekhari,Jakub Klencki,Christopher L. Fryer*

Main category: astro-ph.HE

TL;DR: This study investigates whether ultra-long gamma-ray bursts (ULGRBs) and luminous fast blue optical transients (LFBOTs) share a common origin from mergers of massive helium cores with compact objects. By reanalyzing GRB 111209A/SN 2011kl, the authors find it broadly consistent with an LFBOT origin but with a longer plateau and stronger UV suppression. Host galaxy comparisons show ULGRBs, LFBOTs, and long GRBs all preferentially occur in low-mass, actively star-forming galaxies, supporting a shared progenitor for at least a subset of these transients.


<details>
  <summary>Details</summary>
Motivation: To determine the physical connection between ULGRBs and LFBOTs, two rare classes of engine-driven transients that may both arise from mergers of massive helium cores with compact objects.

Method: Reanalyzed the optical counterpart of GRB 111209A/SN 2011kl using an analytical LFBOT model, and compared host galaxy environments of five ULGRBs to those of LFBOTs and classical long GRBs.

Result: SN 2011kl is broadly consistent with an LFBOT origin (rapid, luminous, blue early emission) but shows a longer ~2-week plateau and stronger UV suppression. ULGRB host galaxies are similar to LFBOT and long GRB hosts: low-mass (<10^10 Msun), actively star-forming galaxies.

Conclusion: The results support a shared progenitor for at least a subset of ULGRBs and LFBOTs.
...
### [28] [Multi-wavelength Constraints on the Transient EP250905a](https://arxiv.org/abs/2607.08090)
...
TL;DR: EP250905a is a fast X-ray transient discovered by Einstein Probe, likely a mildly off-axis structured jet afterglow at z=2.714, with possible weak gravitational lensing (μ≈3.9) by a foreground galaxy at z=0.374.


<details>
  <summary>Details</summary>
Motivation: To constrain the physical origin of the fast X-ray transient EP250905a, given the diverse possible origins of FXTs and the large number (~100/yr) being discovered by the Einstein Probe.

Method: Multi-wavelength (X-ray, optical, NIR, radio) temporal and spectral analysis; spectroscopic redshift measurements of two nearby galaxies; gravitational lensing analysis using the Einstein radius of the foreground galaxy.

Result: EP250905a shows rapid X-ray fading, early optical emission that fades below detection limits, and no detected NIR or radio emission. Two galaxies at z=0.374 (G1) and z=2.714 (G2) are identified; G2 is favored as the host. Potential weak lensing by G1 (μ≈3.9, θ_E≈1.9 arcsec, separation 2.56 arcsec).

Conclusion: The broadband data are best explained as a mildly off-axis structured jet afterglow at z=2.714, with possible weak lensing magnification, providing a consistent physical interpretation for EP250905a.
...
### [29] [The Southern-sky MWA Rapid Two-metre (SMART) pulsar survey--IV. Survey update and an atlas of 205 non-recycled southern pulsars](https://arxiv.org/abs/2607.08106)
...
TL;DR: The SMART survey processes 4 PB of voltage data at 140-170 MHz to detect pulsars and fast transients across the southern sky. This paper presents data products (pulse profiles, time series, multi-channel folded archives) and measurements (DM, RM, mean flux densities) from hundreds of known pulsar redetections—many first detections below 400 MHz—motivated by the need to handle large voltage data processing challenges and to provide a low-frequency reference catalogue for SKA-Low science verification.


<details>
  <summary>Details</summary>
Motivation: Address inherent difficulties in handling large amounts of voltage data and software/processing challenges for routine pulsar detections; support the fast-evolving SKA Observatory (SKAO) by providing a low-frequency catalogue of detectable southern-sky pulsars as a reference for SKA-Low science verification, population studies, survey simulations, emission beam models, and interstellar medium modelling.

Method: Voltage recording with long dwell times and high time/frequency resolution; multi-phase processing of 4 PB of data; dedicated campaigns covering the entire sky south of +30° declination; initial shallow surveys followed by re-detection of hundreds of known pulsars; production of pulse profiles, time series, multi-channel folded archives, and measurements of dispersion measures (DM), rotation measures (RM), and mean flux densities.

Result: Hundreds of known pulsars redetected in the southern sky, many first detections below 400 MHz; growing sample of low-frequency detections and measurements; data products include pulse profiles, time series, multi-channel folded archives, DM, RM, and mean flux densities; catalogue will be periodically updated.

Conclusion: The SMART survey provides a valuable low-frequency reference catalogue of detectable pulsars in the southern sky for SKA-Low science verification, population studies, survey simulations, emission beam models, and interstellar medium modelling. The data products and measurements will be updated as more detections are processed.
...
### [30] [A Magnetar Engine and Circumstellar Medium Interaction: Synergistic Effects in Producing Superluminous Supernovae](https://arxiv.org/abs/2607.08216)
*Guang-Lei Wu,Yun-Wei Yu,Liang-Duan Liu*

Main category: astro-ph.HE

TL;DR: The paper develops a semi-analytical hybrid model for superluminous supernovae that combines magnetar central engine powering with circumstellar interaction, showing this coupled mechanism can produce diverse light-curve morphologies and reduce extreme energy/nickel requirements of single-mechanism models.


<details>
  <summary>Details</summary>
Motivation: SLSNe are typically modeled as powered either by a central engine (magnetar) or by strong CSM interaction, but these mechanisms may be dynamically coupled when ejecta interact with dense CSM while being energized by a newborn magnetar. Existing single-mechanism models often require extreme nickel masses or explosion energies.

Method: A semi-analytical hybrid model that tracks coupled dynamics, energy conversion, and radiative output. It includes: (1) magnetar injection via relativistic wind inflating a hot bubble inside ejecta, (2) outer ejecta-CSM collision forming a CSI region, and (3) the magnetar-driven shock potentially catching up with and taking over the CSI interaction.

Result: The hybrid model produces diverse SLSN light-curve morphologies: luminous interaction-powered peaks, asymmetric post-peak declines, and late-time emission from delayed magnetar-powered radiation leakage. It reduces the extreme nickel-mass or initial explosion-energy requirements of purely radioactive or purely interaction-powered models.

Conclusion: The coupled magnetar+CSI hybrid model offers a more physically realistic and economical explanation for SLSNe, reducing reliance on extreme parameters required by single-mechanism interpretations.
...
### [31] [Exploring the effect of mixing in Low-Luminosity Type IIp Supernovae by modeling SN 2024abfl](https://arxiv.org/abs/2607.08424)
*Akshith Karri,Abigail Polin,Paul Duffell*

Main category: astro-ph.HE

TL;DR: SN 2024abfl, a low-luminosity Type IIp supernova, exhibits a distinct steep drop after the plateau phase. Using MESA and STELLA simulations, the authors find that suppressed mixing during shock breakout can reproduce this light curve feature, offering a proof-of-concept that limited mixing may distinguish LLSNe from typical Type IIp SNe.


<details>
  <summary>Details</summary>
Motivation: To understand the unique steep luminosity drop in the light curve of SN 2024abfl, an LLSN candidate, and investigate whether suppressed ejecta mixing can explain this distinct post-plateau behavior.

Method: Custom pipeline using MESA (stellar evolution) and STELLA (radiation hydrodynamics) to model core-collapse supernova light curves; mixing mechanisms are turned off during shock breakout to test their effect on the plateau-to-radioactive tail transition.

Result: Suppressing mixing mechanisms during shock breakout successfully replicates the flat plateau and steep luminosity drop into the radioactive tail, consistent with previously proposed progenitor parameters (mass, radius, explosion energy).

Conclusion: Limited ejecta mixing may be a key mechanism distinguishing LLSNe from typical Type IIp SNe; this proof-of-concept motivates further exploration of mixing effects in low-luminosity supernova candidates.
...
### [32] [The 20 GeV Galactic Halo Excess: Pixel-Level Confirmation and Consistency with Sub-TeV WIMP Annihilation](https://arxiv.org/abs/2607.08552)
*Trinity Rosebud Stenhouse,Chamkaur Ghag,Frank F. Deppisch*

Main category: astro-ph.HE

TL;DR: A reanalysis of 15 years of Fermi-LAT data confirms a spherically symmetric 20 GeV gamma-ray halo consistent with sub-TeV dark matter annihilation. Best-fit s-wave WIMP models (mχ≈0.55-0.72 TeV, ⟨σv⟩~10^{-24} cm³/s) show 4-5× tension with dwarf spheroidal limits, but accounting for systematics widens the tension window (R≈1.6-9.3), leaving s-wave viable. Alternative models: p-wave fails relic abundance by ~7 orders; decay is disfavored by isotropic gamma-ray background. Only low-velocity-enhanced annihilation (resonant Sommerfeld/Breit-Wigner) can reconcile dwarf limits, halo rates, and relic density, requiring a ≈45× boost from thermal relic and fine-tuning at halo velocities.


<details>
  <summary>Details</summary>
Motivation: To independently reproduce and extend a recent analysis of Fermi-LAT data that reported a 20 GeV spherically symmetric halo-like component of Galactic diffuse emission, and to assess its viability as a dark matter signal given constraints from dwarf spheroidal galaxies, relic abundance, and the isotropic gamma-ray background.

Method: Reproduced cell-aggregated analysis of 15 years of Fermi-LAT data, then extended to pixel-level likelihood on native 0.125° maps with energy-dependent PSF forward folding and bright source masking. Compared cellwise vs. pixel-level fits across NFW emissivity scalings ρ^p (p∈1,2,2.5). Fitted prompt s-wave annihilation spectra and tested alternative DM models: p-wave annihilation, decay, and velocity-enhanced annihilation (resonant Sommerfeld/Breit-Wigner).

Result: Both methods replicate the 20 GeV halo spectrum (pixel-level normalization ~20% above cellwise). The halo is a high-latitude feature distinct from the inner-Galaxy excess, centrally concentrated (disfavoring extragalactic origin). Best-fit s-wave WIMP: mχ≈0.55 TeV (W+W-) and 0.72 TeV (bb̄) with ⟨σv⟩≈1×10^{-24} cm³/s, in ~4-5× tension with dwarf limits (tension window R≈1.6-9.3 with systematics). p-wave misses relic abundance by ~7 orders. Decay disfavored by isotropic gamma-ray background. Only low-velocity-enhanced annihilation (resonant Sommerfeld/Breit-Wigner) reconciles all constraints, requiring ~45× boost from thermal relic and fine-tuning.

Conclusion: The 20 GeV halo is robustly confirmed as a high-latitude, centrally concentrated feature consistent with sub-TeV dark matter annihilation. While s-wave models face moderate tension with dwarf limits, accounting for systematics keeps them viable. The most promising interpretation is low-velocity-enhanced annihilation (resonant Sommerfeld or Breit-Wigner), which can satisfy dwarf limits, present-day halo rates, and relic density simultaneously, albeit with fine-tuning at halo velocities.
...
### [33] [FAST Discovery of $μ$Jy Radio Pulsations from PSR J2238+5903, Providing a DM Distance Anchor for the Candidate TeV Halo 1LHAASO J2238+5900](https://arxiv.org/abs/2607.08596)
...
TL;DR: First detection of radio pulsations from PSR J2238+5903 (a gamma-ray pulsar coincident with TeV source 1LHAASO J2238+5900) using FAST. The pulsar shows P=162.77 ms, DM=247.5 pc cm⁻³, and extremely faint flux density (~3 μJy). DM-based distance estimates (7.4±3.9 kpc) enable assessment of this system as a potential relic-PWN/TeV-halo transition object.


<details>
  <summary>Details</summary>
Motivation: To confirm the radio pulsar counterpart of the gamma-ray pulsar PSR J2238+5903, which is spatially coincident with the extended TeV source 1LHAASO J2238+5900, and to provide a pulsar-specific distance constraint via DM for studying the nature of the TeV emission (relic PWN vs. TeV halo).

Method: 3000 s FAST L-band observation; periodic signal search using both FFT-based and Fast Folding Algorithm (FFA) methods; flux density estimation via the radiometer equation; distance estimation using Galactic electron-density models applied to the measured DM.

Result: Detection of weak periodic radio signal at P=162.76568 ms, DM=247.5±3.0 pc cm⁻³, flux density S₁₂₅₀≈3 μJy (among faintest radio-detected Fermi pulsars). DM-inferred distance d_DM=7.4±3.9 kpc; at this distance the TeV source containment radius corresponds to ~132 pc diameter, and L_TeV≈7.1×10³⁴ erg s⁻¹ (~8% of pulsar spin-down power).

Conclusion: The radio DM provides the first pulsar-specific distance constraint, enabling assessment of whether 1LHAASO J2238+5900 represents a young relic-PWN/TeV-halo transition system.
...
### [34] [Active galactic nuclei are not responsible for systematics in the empirical properties of type Ia supernovae](https://arxiv.org/abs/2607.08604)
*Peter Clark*

Main category: astro-ph.HE

TL;DR: Type Ia supernova Hubble residuals are not significantly affected by the presence of AGNs in their host galaxies (z < 0.15, ZTF DR2 sample).


<details>
  <summary>Details</summary>
Motivation: SN Ia systematic uncertainties, especially those related to astrophysics and environment, remain large and will become more important as statistical errors shrink. The paper investigates whether AGN presence in host galaxies contributes to these systematics.

Method: Using the ZTF SNe Ia DR2 sample, the author compares Hubble residuals of SNe Ia hosted in galaxies with and without AGNs, focusing on the low-redshift regime (z < 0.15).

Result: The presence of AGNs in some SN Ia host galaxies does not produce a significant systematic effect on measured Hubble residuals at z < 0.15.

Conclusion: AGN activity in host galaxies is not a major source of systematic uncertainty for SN Ia cosmology in the low-redshift regime, at least for the ZTF DR2 sample.
...
### [35] [Hα clarifies picture of IIn supernova SN 2015da](https://arxiv.org/abs/2607.08693)
*Nikolai Chugai*

Main category: astro-ph.HE

TL;DR: Reanalysis of SN 2015da shows the Hα-emitting site switches from circumstellar matter to unshocked ejecta around day 90, revealing a supernova explosion energy ≥4×10⁵¹ erg within a ~14 M☉ circumstellar envelope, with an average mass loss rate of 0.035 M☉/yr over 400 yr prior to explosion.


<details>
  <summary>Details</summary>
Motivation: To clarify ambiguous issues in the observational data of type IIn supernova SN 2015da by revisiting the Hα emission site and circumstellar interaction.

Method: Reanalysis of observational data including Hα emission site tracking, bolometric light curve and expansion velocity modeling, and circumstellar interaction modeling.

Result: Hα-emitting site switches from circumstellar matter to unshocked ejecta around day 90; explosion energy ≥4×10⁵¹ erg; circumstellar envelope mass ~14 M☉; average mass loss rate 0.035 M☉/yr over 400 yr before explosion; dust formation occurs in inner unshocked ejecta; Thomson optical depth from Hα modeling on day 46 is consistent with recovered CSM density.

Conclusion: The reanalysis resolves ambiguities in SN 2015da, establishing a clear picture of the emission site transition, dust formation location, and constraining the progenitor's mass loss history and explosion energetics.
...
### [36] [Tilted thin accretion disks in the full Kerr spacetime and their implications](https://arxiv.org/abs/2607.08728)
*K. S. Sruthy,Chandrachur Chakraborty,Sudip Bhattacharyya*

Main category: astro-ph.HE

TL;DR: The paper derives a steady-state warped-disk equation in full Kerr spacetime for thin viscous accretion disks, applicable to both Kerr black holes (a ≤ 1) and naked singularities (a > 1). Without slow-spin approximations, the analytic tilt profiles show significant deviations from weak-field limits. For Kerr naked singularities, a distinct inner tilt hump appears near the vanishing angular momentum radius, which could aid in distinguishing the nature of the central object when combined with disk regime constraints.


<details>
  <summary>Details</summary>
Motivation: To study tilt dynamics of thin viscous accretion disks around spinning collapsed objects (Kerr BHs and naked singularities) using full relativistic treatment, without relying on slow-spin or weak-field approximations, and to identify observational signatures that could distinguish between BHs and naked singularities.

Method: Derivation of a steady-state warped-disk equation in full Kerr spacetime using Pringle's framework, incorporating exact Keplerian and Lense-Thirring precession frequencies, followed by numerical solutions under realistic boundary conditions for both diffusive and likely wave-like regimes.

Result: Significant deviations from slow-spin approximations are found in the inner disk. For Kerr naked singularities (a > 1), the tilt profile shows distinct inner hump(s) near the radius where specific angular momentum vanishes, a feature absent for Kerr BHs (a ≤ 1).

Conclusion: The hump feature alone cannot uniquely distinguish Kerr BHs from naked singularities, but combined with disk regime constraints it may provide observational handles for probing strong gravity, potentially influencing interpretations of X-ray spectral, timing, and polarization data.
...
### [37] [SACRA-K: A Performance-Portable Numerical Relativity Code with Kokkos](https://arxiv.org/abs/2607.08743)
*Ming-Zhe Han,Kenta Kiuchi,Masaru Shibata*

Main category: astro-ph.HE

TL;DR: SACRA-K is a performance-portable numerical relativity code ported from Fortran SACRA-MPI to C++ using Kokkos, validated across binary black hole, BH-NS, and binary neutron star configurations, showing waveform discrepancies below detection thresholds, exact π symmetry, and ~10x speedup on NVIDIA A100 and AMD MI300A accelerators.


<details>
  <summary>Details</summary>
Motivation: To create a performance-portable numerical relativity code that retains the physics and numerics of SACRA-MPI while gaining cross-vendor portability (NVIDIA, AMD) and leveraging accelerator hardware.

Method: Ported SACRA-MPI from Fortran to C++ using the Kokkos library, implementing BSSN spacetime evolution with Z4c constraint propagation, box-in-box Berger-Oliger adaptive mesh refinement, and high-resolution shock capturing for GRHD.

Result: Waveform discrepancies are well below scatter among independent NR codes and resolution-dependent variation, at or below the distinguishability threshold of current GW detectors; π symmetry preserved at bitwise level; BNS merger GW phase exhibits second-order convergence; ~10x speedup on A100 and MI300A vs. Fortran on CPU; scaling up to 256 accelerators.

Conclusion: SACRA-K successfully achieves performance portability across CPU and GPU architectures while maintaining the accuracy and reliability of SACRA-MPI, enabling efficient numerical relativity simulations on diverse hardware.
